...
import { funnelChartChildrenMap, ChartSize, getDataKeys } from "./funnelChartConstants";
...
let FunnelChartTmpComp = (function () {
  return new UICompBuilder({mode:dropdownControl(chartModeOptions,'json'),...funnelChartChildrenMap}, () => null)
    .setPropertyViewFn(funnelChartPropertyView)
    .build();
})();

FunnelChartTmpComp = withViewFn(FunnelChartTmpComp, (comp) => {
...
FunnelChartTmpComp = class extends FunnelChartTmpComp {
...
let FunnelChartComp = withExposingConfigs(FunnelChartTmpComp, [
  depsConfig({
    name: "selectedPoints",
...
export const FunnelChartCompWithDefault = withDefault(FunnelChartComp, {
  xAxisKey: "date",
  series: [
    {
