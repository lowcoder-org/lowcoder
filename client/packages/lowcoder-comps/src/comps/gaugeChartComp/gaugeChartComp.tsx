...
import { gaugeChartChildrenMap, ChartSize, getDataKeys } from "./gaugeChartConstants";
...
let GaugeChartTmpComp = (function () {
  return new UICompBuilder({mode:dropdownControl(chartModeOptions,'json'),...gaugeChartChildrenMap}, () => null)
    .setPropertyViewFn(gaugeChartPropertyView)
    .build();
})();

GaugeChartTmpComp = withViewFn(GaugeChartTmpComp, (comp) => {
...
GaugeChartTmpComp = class extends GaugeChartTmpComp {
...
let GaugeChartComp = withExposingConfigs(GaugeChartTmpComp, [
  depsConfig({
    name: "selectedPoints",
...
export const GaugeChartCompWithDefault = withDefault(GaugeChartComp, {
  xAxisKey: "date",
  series: [
    {
