...
const EchartsOptionMap = {
  tree: TreeChartConfig,
};

const ChartOptionComp = withType(ChartOptionMap, "bar");
const EchartsOptionComp = withType(EchartsOptionMap, "tree");
...
let chartJsonModeChildren: any = {
  echartsData: withDefault(StringControl, trans("treeChart.defaultTitle")),
...
export const treeChartChildrenMap = {
...
const chartUiChildrenMap = uiChildren(treeChartChildrenMap);
