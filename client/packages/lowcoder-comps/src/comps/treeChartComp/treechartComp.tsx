...
import { treeChartChildrenMap, ChartSize, getDataKeys } from "./treeChartConstants";
...
let TreeChartTmpComp = (function () {
  return new UICompBuilder({mode:dropdownControl(chartModeOptions,'json'),...treeChartChildrenMap}, () => null)
...
export const TreeChartCompWithDefault = withDefault(TreeChartComp, {
  xAxisKey: "date",
  series: [
    {
