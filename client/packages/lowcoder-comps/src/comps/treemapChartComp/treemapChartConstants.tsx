...
const EchartsOptionComp = withType(EchartsOptionMap, "treemap");
...
let chartJsonModeChildren: any = {
  echartsData: withDefault(StringControl, trans("treemapChart.defaultTitle")),
...
export const treemapChartChildrenMap = {
...
const chartUiChildrenMap = uiChildren(treemapChartChildrenMap);
