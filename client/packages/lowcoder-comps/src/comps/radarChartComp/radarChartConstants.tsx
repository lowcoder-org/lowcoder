...
const EchartsOptionComp = withType(EchartsOptionMap, "radar");
...
let chartJsonModeChildren: any = {
  echartsData: withDefault(StringControl, trans("radarChart.defaultTitle")),
...
export const radarChartChildrenMap = {
...
const chartUiChildrenMap = uiChildren(radarChartChildrenMap);
