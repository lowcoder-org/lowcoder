...
import { heatmapChartChildrenMap, ChartSize, getDataKeys } from "./heatmapChartConstants";
...
let HeatmapChartTmpComp = (function () {
  return new UICompBuilder({mode:dropdownControl(chartModeOptions,'json'),...heatmapChartChildrenMap}, () => null)
    .setPropertyViewFn(heatmapChartPropertyView)
    .build();
})();

HeatmapChartTmpComp = withViewFn(HeatmapChartTmpComp, (comp) => {
...
HeatmapChartTmpComp = class extends HeatmapChartTmpComp {
...
let HeatmapChartComp = withExposingConfigs(HeatmapChartTmpComp, [
  depsConfig({
    name: "selectedPoints",
...
export const HeatmapChartCompWithDefault = withDefault(HeatmapChartComp, {
  xAxisKey: "date",
  series: [
    {
