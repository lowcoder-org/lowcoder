...
const EchartsOptionMap = {
  graph: GraphChartConfig,
};

const ChartOptionComp = withType(ChartOptionMap, "bar");
const EchartsOptionComp = withType(EchartsOptionMap, "graph");
...
let chartJsonModeChildren: any = {
  echartsData: withDefault(StringControl, trans("graphChart.defaultTitle")),
...
export const graphChartChildrenMap = {
...
const chartUiChildrenMap = uiChildren(graphChartChildrenMap);
