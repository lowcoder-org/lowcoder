...
const EchartsOptionComp = withType(EchartsOptionMap, "sunburst");
...
let chartJsonModeChildren: any = {
  echartsData: withDefault(StringControl, trans("sunburstChart.defaultTitle")),
...
export const sunburstChartChildrenMap = {
...
const chartUiChildrenMap = uiChildren(sunburstChartChildrenMap);
