...
let SankeyChartTmpComp = (function () {
  return new UICompBuilder({mode:dropdownControl(chartModeOptions,'json'),...sankeyChartChildrenMap}, () => null)
    .setPropertyViewFn(sankeyChartPropertyView)
    .build();
})();

SankeyChartTmpComp = withViewFn(SankeyChartTmpComp, (comp) => {
...
SankeyChartTmpComp = class extends SankeyChartTmpComp {
...
let SankeyChartComp = withExposingConfigs(SankeyChartTmpComp, [
  depsConfig({
    name: "selectedPoints",
...
export const SankeyChartCompWithDefault = withDefault(SankeyChartComp, {
  xAxisKey: "date",
  series: [
    {
