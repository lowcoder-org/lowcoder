import { s as we, g as Oe, a as Te, b as Re, c as Dt, d as ue, e as De, f as wt, h as Nt, l as le, i as Se, w as Pe, j as Kt, k as oe, m as Me } from "./1269154d.js";
import { d as Le, g as Ne } from "./5bb002c8.js";
var Yt = function() {
  var e = function(bt, _, x, m) {
    ...
    parse: function(_) {
      ...
      for (var M, kt, N, qt, Ct = {}, Mt, z, re, Lt; ; ) {
        if (kt = m[m.length - 1], this.defaultActions[kt] ? N = this.defaultActions[kt] : ((M === null || typeof M == "undefined") && (M = Ce()), N = Tt[kt] && Tt[kt][M]), typeof N == "undefined" || !N.length || !N[0]) {
          var Gt = "";
          Lt = [];
          for (Mt in Tt[kt])
...
const Ye = function() {
  ...
  let r = i.startsWith("data:image/png;base64") ? i : Me.sanitizeUrl(i);
  s.attr("xlink:href", r);
}, u0 = (e, t, a) => {
  const o = e.append("g");
  let l = 0;
...
const $t = function(e) {
  De(b, e), e.fontFamily && (b.personFontFamily = b.systemFontFamily = b.messageFontFamily = e.fontFamily), e.fontSize && (b.personFontSize = b.systemFontSize = b.messageFontSize = e.fontSize), e.fontWeight && (b.personFontWeight = b.systemFontWeight = b.messageFontWeight = e.fontWeight);
}, Rt = (e, t) => ({
  fontFamily: e[t + "FontFamily"],
  fontSize: e[t + "FontSize"],
  fontWeight: e[t + "FontWeight"]
...
function I(e, t, a, o, l) {
  if (!t[e].width)
    if (a)
      t[e].text = Pe(t[e].text, l, o), t[e].textLines = t[e].text.split(Kt.lineBreakRegex).length, t[e].width = l, t[e].height = oe(t[e].text, o);
    else {
...
const w0 = function(e, t, a, o) {
  ...
  f && n.append("text").text(f).attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX).attr("y", p.starty + b.diagramMarginY), Se(n, O, S, b.useMaxWidth);
  const L = f ? 60 : 0;
  n.attr(
    "viewBox",
