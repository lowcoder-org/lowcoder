...
import { p as N, c as b, d as J, b6 as V, h as C, l as g, A as U, F as ct } from "./1269154d.js";
import { a as it } from "./945d7302.js";
import { l as ht } from "./e437d53e.js";
const ot = (e, t, r, i) => {
  t.forEach((l) => {
    mt[l](e, r, i);
  });
...
}, I = Lt, T = (e, t, r, i) => v(void 0, null, function* () {
  let l;
          ...
          (u) => new Promise((M) => {
            function E() {
              if (u.style.display = "flex", u.style.flexDirection = "column", x) {
                const $ = b().fontSize ? b().fontSize : window.getComputedStyle(document.body).fontSize, Y = 5, D = parseInt($, 10) * Y + "px";
...
const Et = (e, t) => {
...
}, P = (e) => e ? " " + e : "", H = (e, t) => `${t || "node default"}${P(e.classes)} ${P(
  e.class
  ...
  const { shapeSvg: r, bbox: i } = yield T(e, t, void 0, !0), l = 2, a = i.height + 2 * t.padding, s = a / l, n = i.width + 2 * s + t.padding, c = Ht(t.directions, i, t), o = O(r, n, a, c);
  return o.attr("style", t.style), m(t, o), t.intersect = function(h) {
    return w.polygon(t, c, h);
  }, r;
  ...
  const { shapeSvg: r, bbox: i } = yield T(e, t, H(t), !0), l = i.width + t.padding, a = i.height + t.padding, s = [
    { x: -2 * a / 6, y: 0 },
    { x: l - a / 6, y: 0 },
    { x: l + 2 * a / 6, y: -a },
    { x: a / 6, y: -a }
...
const Ft = (e, t) => {
  ...
  const p = s.node().appendChild(
    I(y.join ? y.join("<br/>") : y, t.labelStyle, !0, !0)
  );
  if (N(b().flowchart.htmlLabels)) {
  ...
  let p = 0;
  const d = t.classData.annotations && t.classData.annotations[0], k = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", x = f.node().appendChild(I(k, t.labelStyle, !0, !0));
  let u = x.getBBox();
  if (N(b().flowchart.htmlLabels)) {
  ...
  const E = f.node().appendChild(I(M, t.labelStyle, !0, !0));
  ...
  if (t.classData.methods.forEach((L) => {
    ...
    R.width > h && (h = R.width), y += R.height + i, D.push(W);
  }), y += l, d) {
    let L = (h - u.width) / 2;
    C(x).attr(
      "transform",
  ...
  }), p += l, o.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -y / 2 - r + l + p).attr("y2", -y / 2 - r + l + p), p += l, D.forEach((L) => {
    var _;
    C(L).attr(
      "transform",
...
const pr = (e, t, r) => v(void 0, null, function* () {
  ...
  return t.tooltip && l.attr("title", t.tooltip), t.class && l.attr("class", "node default " + t.class), i.attr("data-node", "true"), i.attr("data-id", t.id), A[t.id] = i, t.haveCallback && A[t.id].attr("class", A[t.id].attr("class") + " clickable"), i;
}), fr = (e, t) => {
  A[t.id] = e;
}, xr = () => {
  A = {};
...
const gr = () => {
  ...
  const r = N(b().flowchart.htmlLabels), i = t.labelType === "markdown" ? it(e, t.label, {
    ...
    useHtmlLabels: r,
    addSvgBackground: !0
  }) : I(t.label, t.labelStyle), l = e.insert("g").attr("class", "edgeLabel"), a = l.insert("g").attr("class", "label");
  ...
  let n;
  if (t.startLabelLeft) {
    const c = I(t.startLabelLeft, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
  ...
  if (t.startLabelRight) {
    const c = I(t.startLabelRight, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
  ...
  if (t.endLabelLeft) {
    const c = I(t.endLabelLeft, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    n = h.node().appendChild(c);
    const y = c.getBBox();
    h.attr("transform", "translate(" + -y.width / 2 + ", " + -y.height / 2 + ")"), o.node().appendChild(c), B[t.id] || (B[t.id] = {}), B[t.id].endLeft = o, Z(n, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const c = I(t.endLabelRight, t.labelStyle), o = e.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    n = h.node().appendChild(c);
    const y = c.getBBox();
