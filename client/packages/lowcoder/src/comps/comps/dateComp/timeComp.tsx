...
export let timePickerControl = new UICompBuilder(childrenMap, (props) => {
...
export let timeRangeControl = (function () {
  const childrenMap = {
...
export const TimePickerComp = withExposingConfigs(timePickerControlBuilder, [
