...
import { matrixClient } from "./chatControllerComp";
...
const childrenMap = {
  ...
  roomData: stringExposingStateControl(""),
  participants: stringExposingStateControl(""),
};
...
const ChatsCompBase = (
  ...
  const handleSubmit = async () => {
    ...
    console.log(mentionList, subObject);
...
let ChatsBasicComp = (function () {
  return new UICompBuilder(childrenMap, (props, dispatch) => (
    <ChatsCompBase {...props} dispatch={dispatch} />
  ))
    .setPropertyViewFn((children) => (
      <>
        <Section name={sectionNames.basic}>
          ...
          {children.roomData.propertyView({ label: trans("chat.roomData") })}
...
ChatsBasicComp = class extends ChatsBasicComp {
  override autoHeight(): boolean {
    return false;
  }
};
export const ChatsComp = withExposingConfigs(ChatsBasicComp, [
