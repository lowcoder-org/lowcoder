...
import { CustomModal, DocLink, TacoButton, TacoInput } from "lowcoder-design";
...
export default function PluginPanel() {
  ...
  return (
    <>
      ...
      <Footer>
        <TacoButton icon={<MultiIconDisplay identifier="/icon:svg/BluePlusIcon" />} buttonType="blue" onClick={() => showAddModal(true)}>
