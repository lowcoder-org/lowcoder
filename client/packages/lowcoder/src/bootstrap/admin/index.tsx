...
export var uiCompMap: Registry = {
      ...
      candleStickChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/CandlestickChartCompIcon"),
      ...
      funnelChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/FunnelChartCompIcon"),
      ...
      gaugeChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/GaugeChartCompIcon"),
      ...
      graphChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/GraphChartCompIcon"),
      ...
      heatmapChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/HeatmapChartCompIcon"),
      ...
      radarChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/RadarChartCompIcon"),
      ...
      sankeyChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/SankeyChartCompIcon"),
      ...
      sunburstChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/SunburstChartCompIcon"),
      ...
      themeriverChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/ThemeriverChartCompIcon"),
      ...
      treeChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/TreeChartCompIcon"),
      ...
      treemapChart: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/TreemapChartCompIcon"),
      ...
      openLayersGeoMap: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/GeoMapLayersCompIcon"),
      ...
      chartsGeoMap: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/GeoMapChartsCompIcon"),
      ...
      pivotTable: {
        ...
        categories: ["dashboards"],
        icon: MultiIcon("/icon:svg/PivotTableCompIcon"),
      ...
      pageLayout: {
        ...
        categories: ["layout"],
        icon: MultiIcon("/icon:svg/PageLayoutCompIcon"),
      ...
      columnLayout: {
        ...
        description: trans("uiComp.responsiveLayoutCompDesc"),
        categories: ["layout"],
        icon: MultiIcon("/icon:svg/ColumnLayoutCompIcon"),
        keywords: trans("uiComp.responsiveLayoutCompKeywords"),
        lazyLoad: true,
      ...
      floatTextContainer: {
        ...
        categories: ["layout"],
        icon: MultiIcon("/icon:svg/FloatingTextCompIcon"),
      ...
      card: {
        ...
        enName: "card",
        icon: MultiIcon("/icon:svg/CardCompIcon"),
      ...
      step: {
        ...
        categories: ["layout"],
        icon: MultiIcon("/icon:svg/StepCompIcon"),
      ...
      floatingButton: {
        ...
        categories: ["layout"],
        icon: MultiIcon("/icon:svg/FloatingButtonCompIcon"),
      ...
      timer: {
        ...
        enName: "timer",
        icon: MultiIcon("/icon:svg/TimerCompIcon"),
      ...
      sharingcomponent: {
        ...
        icon: MultiIcon("/icon:svg/VideoScreenshareCompIcon"),
      ...
      videocomponent: {
        ...
        categories: ["collaboration"],
        icon: MultiIcon("/icon:svg/VideoCameraStreamCompIcon"),
        keywords: trans("meeting.meetingCompKeywords"),
      ...
      meeting: {
        ...
        categories: ["collaboration"],
        icon: MultiIcon("/icon:svg/VideoMeetingRoomCompIcon"),
        keywords: trans("meeting.meetingCompKeywords"),
        withoutLoading: true,
      },
      ...
      avatar: {
        ...
        categories: ["collaboration"],
        icon: MultiIcon("/icon:svg/AvatarCompIcon"),
      ...
      avatarGroup: {
        ...
        enName: "avatarGroup",
        icon: MultiIcon("/icon:svg/AvatarGroupCompIcon"),
      ...
      controlButton: {
        ...
        icon: MultiIcon("/icon:svg/IconButtonCompIcon"),
      ...
      ganttChart: {
        ...
        icon: MultiIcon("/icon:svg/GanttCompIcon"),
      ...
      kanban: {
        ...
        categories: ["projectmanagement"],
        icon: MultiIcon("/icon:svg/KanbanCompIcon"),
      ...
      hillchart: {
        ...
        categories: ["projectmanagement"],
        icon: MultiIcon("/icon:svg/HillchartCompIcon"),
      ...
      bpmnEditor: {
        ...
        icon: MultiIcon("/icon:svg/BPMNEditorCompIcon"),
      ...
      shape: {
        ...
        icon: MultiIcon("/icon:svg/ShapesCompIcon"),
  ...
  icon: {
    ...
    categories: ["multimedia"],
    icon: MultiIcon("/icon:svg/IconCompIcon"),
    ...
    colorPicker: {
      ...
      categories: ["multimedia"],
      icon: MultiIcon("/icon:svg/ColorPickerCompIcon"),
    ...
    tour: {
      ...
      icon: MultiIcon("/icon:svg/TourCompIcon"),
    ...
    transfer: {
      ...
      enName: "transfer",
      icon: MultiIcon("/icon:svg/TransferCompIcon"),
    ...
    turnstileCaptcha: {
      ...
      categories: ["itemHandling"],
      icon: MultiIcon("/icon:svg/TurnstileCaptchaCompIcon"),
