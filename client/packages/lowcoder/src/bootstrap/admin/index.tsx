...
export var uiCompMap: Registry = {
  ...
  candleStickChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(CandlestickChartCompIcon),
  ...
  funnelChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(FunnelChartCompIcon),
  ...
  gaugeChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(GaugeChartCompIcon),
  ...
  graphChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(GraphChartCompIcon),
  ...
  heatmapChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(HeatmapChartCompIcon),
  ...
  radarChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(RadarChartCompIcon),
  ...
  sunburstChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(SunburstChartCompIcon),
  ...
  themeriverChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(ThemeriverChartCompIcon),
  ...
  treeChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(TreeChartCompIcon),
  ...
  treemapChart: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(TreemapChartCompIcon),
  ...
  openLayersGeoMap: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(GeoMapLayersCompIcon),
  ...
  chartsGeoMap: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(GeoMapChartsCompIcon),
  ...
  pivotTable: {
    ...
    categories: ["dashboards"],
    icon: MultiIcon(PivotTableCompIcon),
  ...
  columnLayout: {
    ...
    description: trans("uiComp.responsiveLayoutCompDesc"),
    categories: ["layout"],
    icon: MultiIcon(ColumnLayoutCompIcon),
    keywords: trans("uiComp.responsiveLayoutCompKeywords"),
    lazyLoad: true,
  ...
  floatTextContainer: {
    ...
    categories: ["layout"],
    icon: MultiIcon(FloatingTextCompIcon),
  ...
  floatingButton: {
    ...
    categories: ["layout"],
    icon: MultiIcon(FloatingButtonCompIcon),
  ...
  sharingcomponent: {
    ...
    icon: MultiIcon(VideoScreenshareCompIcon),
  ...
  videocomponent: {
    ...
    categories: ["collaboration"],
    icon: MultiIcon(VideoCameraStreamCompIcon),
    keywords: trans("meeting.meetingCompKeywords"),
  ...
  meeting: {
    ...
    categories: ["collaboration"],
    icon: MultiIcon(VideoMeetingRoomCompIcon),
    keywords: trans("meeting.meetingCompKeywords"),
    withoutLoading: true,
  },
  ...
  avatarGroup: {
    ...
    enName: "avatarGroup",
    icon: MultiIcon(AvatarGroupCompIcon),
  ...
  controlButton: {
    ...
    icon: MultiIcon(IconButtonCompIcon),
  ...
  hillchart: {
    ...
    categories: ["projectmanagement"],
    icon: MultiIcon(HillchartCompIcon),
  ...
  bpmnEditor: {
    ...
    icon: MultiIcon(BPMNEditorCompIcon),
  ...
  colorPicker: {
    ...
    categories: ["multimedia"],
    icon: MultiIcon(ColorPickerCompIcon),
  ...
  transfer: {
    ...
    enName: "transfer",
    icon: MultiIcon(TransferCompIcon),
  ...
  turnstileCaptcha: {
    ...
    categories: ["itemHandling"],
    icon: MultiIcon(TurnstileCaptchaCompIcon),
