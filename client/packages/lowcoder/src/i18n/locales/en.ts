...
export const en = {
  ...
  productDesc:
    'Create software applications for your company and customers with minimal coding experience. Lowcoder is an excellent alternative to Retool, Appsmith, and Tooljet.',
  notSupportedBrowser:
    'Your current browser may have compatibility issues. For an optimal user experience, please use the latest version of Chrome.',
  create: 'Create',
  move: 'Move',
  addItem: 'Add',
  newItem: 'New',
  ...
  api: {
    ...
    needUpdate:
      'Your current version is outdated. Please upgrade to the latest version.',
  },
  codeEditor: {
    notSupportAutoFormat:
      'The current code editor does not support auto-formatting.',
    fold: 'Fold',
  },
  exportMethod: {
  ...
  gridCompOperator: {
    ...
    cutCompsSuccess:
      'Cut successfully. Press {pasteKey} to paste, or {undoKey} to undo.',
  },
  leftPanel: {
  ...
  rightPanel: {
    ...
    noSelectedComps:
      'No Components selected. Click a Component to view its Properties.',
    createTab: 'Insert',
    ...
    emptyModules:
      'Modules are reusable Mikro-Apps. You can embed them in your App.',
  ...
  prop: {
    ...
    readOnly: 'Read Only',
    readOnlyTooltip:
      'Read-only components appear normal but cannot be modified.',
    minimum: 'Minimum',
    maximum: 'Maximum',
    regex: 'Regex',
    ...
    customRuleTooltip:
      'Non-empty string indicates an error; empty or null means validation passed. Example: ',
    manual: 'Manual',
    map: 'Map',
    json: 'JSON',
    ...
    siderCollapsedWidthTooltip:
      'Sider collapsed width supports percentages (%) and pixels (px).',
    ...
    showAppTooltip:
      'You can display whole Apps in the content area. Please mind, that for Modules we do not support Inputs, Outputs Events and Methods.',
  ...
  eventHandler: {
    ...
    notifyDurationTooltip:
      "Time unit can be 's' (second, default) or 'ms' (millisecond). Max duration is {max} seconds",
    goToURL: 'Open a URL',
    ...
    fileName: 'File Name',
    fileNameTooltip:
      "Include extension to specify file type, e.g., 'image.png'",
    fileType: 'File Type',
    condition: 'Run Only When...',
    conditionTooltip:
      "Run the event handler only when this condition evaluates to 'true'",
    debounce: 'Debounce for',
    throttle: 'Throttle for',
    slowdownTooltip:
      "Use debounce or throttle to control the frequency of action triggers. Time unit can be 'ms' (millisecond, default) or 's' (second).",
    ...
    editedEventHandlersDesc:
      'Event Handlers related to edited state of Elements',
    ...
    elementEventHandlersDesc:
      'Event Handlers related to generic Data Element Events',
    ...
    collaborationEventHandlersDesc:
      'Event Handlers related to Collaboration Events',
    set: 'Set',
    clear: 'Clear',
    reset: 'Reset',
  ...
  themeDetail: {
    ...
    containerheaderpaddingDesc:
      'Default header padding typically used for most components',
    gridColumns: 'Grid Columns',
    gridColumnsDesc:
      'Default number of columns typically used for most containers',
  },
  ...
  query: {
    ...
    failConditionTooltip1:
      'Customize failure conditions and corresponding notifications.',
    failConditionTooltip2:
      'If any condition returns true, the query is marked as failed and triggers the corresponding notification.',
    showSuccessNotification: 'Show Notification on Success',
    successMessageLabel: 'Success Message',
    successMessage: 'Run Successful',
    notifyDuration: 'Duration',
    notifyDurationTooltip:
      "Notification duration. Time unit can be 's' (second, default) or 'ms' (millisecond). Default value is {default}s. Maximum is {max}s.",
    ...
    disablePreparedStatementTooltip:
      'Disabling prepared statements can generate dynamic SQL, but increases the risk of SQL injection',
    timeout: 'Timeout After',
    timeoutTooltip:
      'Default unit: ms. Supported input units: ms, s. Default value: {defaultSeconds} seconds. Maximum value: {maxSeconds} seconds. E.g., 300 (i.e., 300ms), 800ms, 5s.',
    periodic: 'Run This Data Query Periodically',
    periodicTime: 'Period',
    periodicTimeTooltip:
      'Period between successive executions. Default unit: ms. Supported input units: ms, s. Minimum value: 100ms. Periodical execution is disabled for values below 100ms. E.g., 300 (i.e., 300ms), 800ms, 5s.',
    cancelPrevious: 'Ignore Results of Previous Uncompleted Executions',
    cancelPreviousTooltip:
      'If a new execution is triggered, the result of the previous uncompleted executions will be ignored if they did not complete, and these ignored executions will not trigger the event list of the query.',
    ...
    enableTurnOffPreparedStatementTooltip:
      "You can enable or disable prepared statements in the query's Advanced tab",
    ...
    database: 'Database',
    cloudHosting:
      'Cloud-hosted Lowcoder cannot access local services using 127.0.0.1 or localhost. Try connecting to public network data sources or use a reverse proxy for private services.',
    notCloudHosting:
      'For docker-hosted deployment, Lowcoder uses bridge networks, so 127.0.0.1 and localhost are invalid for host addresses. To access local machine data sources, refer to',
    ...
    whitelist: 'Allowlist',
    whitelistTooltip:
      "Add Lowcoder's IP addresses to your data source allowlist as needed.",
    address: 'Address: ',
    nameExists: 'Name {name} already exists',
    jsQueryDocLink: 'About JavaScript Query',
    dynamicDataSourceConfigLoadingText:
      'Loading extra datasource configuration...',
    dynamicDataSourceConfigErrText:
      'Failed to load extra datasource configuration.',
    retry: 'Retry',
  },
  ...
  sqlQuery: {
    ...
    allowMultiModifyTooltip:
      'If selected, all rows meeting the conditions are operated on. Otherwise, only the first row meeting the conditions is operated on.',
    array: 'Array',
  ...
  queryLibrary: {
    ...
    deleteQueryContent:
      'The query cannot be recovered after deletion. Delete the query?',
    run: 'Run',
    readOnly: 'Read Only',
    exit: 'Exit',
  ...
  httpQuery: {
    bodyFormDataTooltip:
      'If {type} is selected, the value format should be {object}. Example: {example}',
    text: 'Text',
    file: 'File',
    extraBodyTooltip:
      'Key-values in Extra Body will be appended to the body with JSON or Form Data types',
  ...
  smtpQuery: {
    ...
    attachmentTooltip:
      'Can be used with file upload component, data needs to be converted to: ',
    MIMETypeUrl:
  ...
  uiComp: {
    ...
    autoCompleteCompDesc:
      'An input field that provides suggestions as you type, enhancing user experience and accuracy.',
    autoCompleteCompKeywords: 'suggestions, autocomplete, typing, input',

    inputCompName: 'Input',
    inputCompDesc:
      'A basic text input field allowing users to enter and edit text.',
    inputCompKeywords: 'text, input, field, edit',

    textAreaCompName: 'Text Area',
    textAreaCompDesc:
      'A multi-line text input for longer form content, such as comments or descriptions.',
    textAreaCompKeywords: 'multiline, textarea, input, text',

    passwordCompName: 'Password',
    passwordCompDesc:
      'A secure field for password input, masking the characters for privacy.',
    passwordCompKeywords: 'password, security, input, hidden',

    richTextEditorCompName: 'Rich Text Editor',
    richTextEditorCompDesc:
      'An advanced text editor supporting rich formatting options like bold, italics, and lists.',
    richTextEditorCompKeywords: 'editor, text, formatting, rich content',

    numberInputCompName: 'Number Input',
    numberInputCompDesc:
      'A field specifically for numerical input, with controls for incrementing and decrementing values.',
    numberInputCompKeywords: 'number, input, increment, decrement',

    sliderCompName: 'Slider',
    sliderCompDesc:
      'A graphical slider component for selecting a value or range within a defined scale.',
    sliderCompKeywords: 'slider, range, input, graphical',

    rangeSliderCompName: 'Range Slider',
    rangeSliderCompDesc:
      'A dual-handle slider to select a range of values, useful for filtering or setting limits.',
    rangeSliderCompKeywords: 'range, slider, dual-handle, filter',

    ratingCompName: 'Rating',
    ratingCompDesc:
      'A component for capturing user ratings, displayed as stars.',
    ...
    multiSelectCompDesc:
      'A component that allows selection of multiple items from a dropdown list.',
    multiSelectCompKeywords: 'multiselect, multiple, dropdown, choices',

    cascaderCompName: 'Cascader',
    cascaderCompDesc:
      'A multi-level dropdown for hierarchical data selection, such as selecting a location.',
    cascaderCompKeywords: 'cascader, hierarchical, dropdown, levels',

    checkboxCompName: 'Checkbox',
    checkboxCompDesc:
      'A standard checkbox for options that can be selected or deselected.',
    checkboxCompKeywords: 'checkbox, options, select, toggle',

    radioCompName: 'Radio',
    radioCompDesc:
      'Radio buttons for selecting one option from a set, where only one choice is allowed.',
    radioCompKeywords: 'radio, buttons, select, single choice',

    segmentedControlCompName: 'Segmented Control',
    segmentedControlCompDesc:
      'A control with segmented options for quickly toggling between multiple choices.',
    segmentedControlCompKeywords: 'segmented, control, toggle, options',

    stepControlCompName: 'Step Control',
    stepControlCompDesc:
      'A control with step options to offer visual guided steps for applications like forms or wizards.',
    stepControlCompKeywords: 'steps, control, toggle, options',

    fileUploadCompName: 'File Upload',
    fileUploadCompDesc:
      'A component for uploading files, with support for drag-and-drop and file selection.',
    ...
    dateRangeCompDesc:
      'A component for selecting a range of dates, useful for booking systems or filters.',
    dateRangeCompKeywords: 'daterange, select, booking, filter',

    timeCompName: 'Time',
    timeCompDesc:
      'A time selection component for choosing specific times of the day.',
    timeCompKeywords: 'time, picker, select, clock',

    timeRangeCompName: 'Time Range',
    timeRangeCompDesc:
      'A component for selecting a range of time, often used in scheduling applications.',
    timeRangeCompKeywords: 'timerange, select, scheduling, duration',

    buttonCompName: 'Form Button',
    buttonCompDesc:
      'A versatile button component for submitting forms, triggering actions, or navigating.',
    buttonCompKeywords: 'button, submit, action, navigate',

    meetingControlCompName: 'Icon Button',
    meetingCompDesc:
      'A button for controlling functions like start, end, mute, or share.',
    meetingCompKeywords: 'control, button, start, end',

    linkCompName: 'Link',
    linkCompDesc:
      'A hyperlink display component for navigation or linking to external resources.',
    linkCompKeywords: 'link, hyperlink, navigation, external',

    scannerCompName: 'Scanner',
    scannerCompDesc:
      'A component for scanning barcodes, QR codes, and other similar data.',
    scannerCompKeywords: 'scanner, barcode, QR code, scan',

    dropdownCompName: 'Dropdown',
    dropdownCompDesc:
      'A dropdown menu for compactly displaying a list of options.',
    dropdownCompKeywords: 'dropdown, menu, options, select',

    toggleButtonCompName: 'Toggle Button',
    toggleButtonCompDesc:
      'A button that can toggle between two states or options.',
    toggleButtonCompKeywords: 'toggle, button, switch, state',

    textCompName: 'Text Display',
    textCompDesc:
      'A simple component for displaying static or dynamic text content inclusive Markdown formatting.',
    ...
    imageCompName: 'Image',
    imageCompDesc:
      'A component for displaying images, supporting various formats based on URI or Base64 Data.',
    imageCompKeywords: 'image, display, media, Base64',

    progressCompName: 'Progress',
    progressCompDesc:
      'A visual indicator of progress, typically used to show the completion status of a task.',
    progressCompKeywords: 'progress, indicator, status, task',

    progressCircleCompName: 'Progress Circle',
    progressCircleCompDesc:
      'A circular progress indicator, often used for loading states or time-bound tasks.',
    progressCircleCompKeywords: 'circle, progress, indicator, loading',

    fileViewerCompName: 'File Viewer',
    fileViewerCompDesc:
      'A component for viewing various types of files, including documents and images.',
    fileViewerCompKeywords: 'file, viewer, document, image',

    dividerCompName: 'Divider',
    dividerCompDesc:
      'A visual divider component, used to separate content or sections in a layout.',
    dividerCompKeywords: 'divider, separator, layout, design',

    qrCodeCompName: 'QR Code',
    qrCodeCompDesc:
      'A component for displaying QR codes, useful for quick scanning and information transfer.',
    qrCodeCompKeywords: 'QR code, scanning, barcode, information',

    formCompName: 'Form',
    formCompDesc:
      'A container component for building structured forms with various input types.',
    formCompKeywords: 'form, input, container, structure',

    jsonSchemaFormCompName: 'JSON Schema Form',
    jsonSchemaFormCompDesc:
      'A dynamic form component generated based on a JSON schema.',
    jsonSchemaFormCompKeywords: 'JSON, schema, form, dynamic',

    containerCompName: 'Container',
    containerCompDesc:
      'A general-purpose container for layout and organization of UI elements.',
    ...
    collapsibleContainerCompDesc:
      'A container that can be expanded or collapsed, ideal for managing content visibility.',
    collapsibleContainerCompKeywords:
      'collapsible, container, expand, collapse',

    tabbedContainerCompName: 'Tabbed Container',
    tabbedContainerCompDesc:
      'A container with tabbed navigation for organizing content into separate panels.',
    tabbedContainerCompKeywords: 'tabbed, container, navigation, panels',

    pageLayoutCompName: 'Page Layout',
    pageLayoutCompDesc:
      'A container which offers to create a layout with header, sider, footer and main content areas',
    pageLayoutCompKeywords: 'layout, container, navigation, pages',

    modalCompName: 'Modal',
    modalCompDesc:
      'A pop-up modal component for displaying content, alerts, or forms in focus.',
    modalCompKeywords: 'modal, popup, alert, form',

    listViewCompName: 'List View',
    listViewCompDesc:
      'A component for displaying a list of items or data, where you can place other components inside. Like a repeater.',
    listViewCompKeywords: 'list, view, display, repeater',

    gridCompName: 'Grid',
    gridCompDesc:
      'A flexible grid component for creating structured layouts with rows and columns as an extension to the List View component.',
    gridCompKeywords: 'grid, layout, rows, columns',

    navigationCompName: 'Navigation',
    navigationCompDesc:
      'A navigation component for creating menus, breadcrumbs, or tabs for site navigation.',
    navigationCompKeywords: 'navigation, menu, breadcrumbs, tabs',

    iframeCompName: 'IFrame',
    iframeCompDesc:
      'An inline frame component for embedding external web pages and apps or content within the application.',
    iframeCompKeywords: 'iframe, embed, web page, content',

    customCompName: 'Custom Component',
    customCompDesc:
      'A flexible, programmable component for creating unique, user-defined UI elements tailored to your specific needs.',
    customCompKeywords: 'custom, user-defined, flexible, programmable',

    moduleCompName: 'Module',
    moduleCompDesc:
      'Use Modules to create Micro-Apps designed for encapsulating specific functionalities or features. Modules can be then embedded and reused across all Apps.',
    moduleCompKeywords: 'module, micro-app, functionality, reusable',

    jsonExplorerCompName: 'JSON Explorer',
    jsonExplorerCompDesc:
      'A component for visually exploring and interacting with JSON data structures.',
    jsonExplorerCompKeywords: 'JSON, explorer, data, structure',

    jsonEditorCompName: 'JSON Editor',
    jsonEditorCompDesc:
      'An editor component for creating and modifying JSON data with validation and syntax highlighting.',
    jsonEditorCompKeywords: 'JSON, editor, modify, validate',

    treeCompName: 'Tree',
    treeCompDesc:
      'A tree structure component for displaying hierarchical data, such as file systems or organizational charts.',
    treeCompKeywords: 'tree, hierarchical, data, structure',

    treeSelectCompName: 'Tree Select',
    treeSelectCompDesc:
      'A selection component that presents options in a hierarchical tree format, allowing for organized and nested selections.',
    treeSelectCompKeywords: 'tree, select, hierarchical, nested',

    audioCompName: 'Audio',
    audioCompDesc:
      'A component for embedding audio content, with controls for playback and volume adjustment.',
    audioCompKeywords: 'audio, playback, sound, music',

    videoCompName: 'Video',
    videoCompDesc:
      'A multimedia component for embedding and playing video content, with support for various formats.',
    videoCompKeywords: 'video, multimedia, playback, embed',

    drawerCompName: 'Drawer',
    drawerCompDesc:
      'A sliding panel component that can be used for additional navigation or content display, typically emerging from the edge of the screen.',
    ...
    carouselCompDesc:
      'A rotating carousel component for showcasing images, banners, or content slides.',
    carouselCompKeywords: 'carousel, images, rotation, showcase',

    imageEditorCompName: 'Image Editor',
    imageEditorCompDesc:
      'An interactive component for editing and manipulating images, offering various tools and filters.',
    imageEditorCompKeywords: 'image, editor, manipulate, tools',

    mermaidCompName: 'Mermaid Chart',
    mermaidCompDesc:
      'A component for rendering complex diagrams and flowcharts based on Mermaid syntax.',
    mermaidCompKeywords: 'mermaid, charts, diagrams, flowcharts',

    calendarCompName: 'Calendar',
    calendarCompDesc:
      'A calendar component for displaying dates and events, with options for month, week, or day views.',
    calendarCompKeywords: 'calendar, dates, events, scheduling',

    signatureCompName: 'Signature',
    signatureCompDesc:
      'A component for capturing digital signatures, useful for approvals and verification processes.',
    signatureCompKeywords: 'signature, digital, approval, verification',

    jsonLottieCompName: 'Lottie Animation',
    jsonLottieCompDesc:
      'A component for displaying Lottie animations, providing lightweight and scalable animations based on JSON data.',
    jsonLottieCompKeywords: 'lottie, animation, JSON, scalable',

    timelineCompName: 'Timeline',
    timelineCompDesc:
      'A component for displaying events or actions in a chronological order, visually represented along a linear timeline.',
    timelineCompKeywords: 'timeline, events, chronological, history',

    commentCompName: 'Comment',
    commentCompDesc:
      'A component for adding and displaying user comments, supporting threaded replies and user interaction.',
    commentCompKeywords: 'comment, discussion, user interaction, feedback',

    mentionCompName: 'Mention',
    mentionCompDesc:
      'A component that supports mentioning users or tags within text content, typically used in social media or collaborative platforms.',
    mentionCompKeywords: 'mention, tag, user, social media',

    responsiveLayoutCompName: 'Responsive Layout',
    responsiveLayoutCompDesc:
      'A layout component designed to adapt and respond to different screen sizes and devices, ensuring a consistent user experience.',
    responsiveLayoutCompKeywords: 'responsive, layout, adapt, screen size',

    iconCompName: 'Icons',
    iconCompDesc:
      'Use various Icons to enhance the visual appeal and user experience of your application.',
    iconCompKeywords: 'Icons, pictograms, symbols, shapes',

    tourCompName: 'Tour',
    tourCompDesc: 'A product tour for guiding users.',
    tourCompKeywords:
      'tour, product tour, walkthrough, interactive walkthrough',

    hillchartCompName: 'Hillchart',
    hillchartCompDesc:
      'A visualization component for displaying project management state data in a hill chart format.',
    hillchartCompKeywords:
      'project management, hill chart, visualization, data',

    openLayersGeoMapCompName: 'Openlayers Geomap',
    openLayersGeoMapCompDesc:
      'A component for displaying interactive maps using OpenLayers, with support for various map layers and features.',
    openLayersGeoMapCompKeywords:
      'openlayers, geo map, interactive, map layers',

    chartsGeoMapCompName: 'Geo Map Charts',
    chartsGeoMapCompDesc:
      'A component for visualizing geographical data on interactive maps with dynamic charts',
    chartsGeoMapCompKeywords:
      'geo map, charts, visualization, geographical data',

    bpmnEditorCompName: 'BPMN Editor',
    bpmnEditorCompDesc:
      'A component for viewing, creating and editing BPMN diagrams, supporting various BPMN elements and features.',
    ...
    turnstileCaptchaCompDesc:
      'A captcha component to verify users against bots.',
    turnstileCaptchaCompKeywords: 'captcha, verification, identity, security',

    pivotTableCompName: 'Pivot Table',
    pivotTableCompDesc:
      'A data summarization and analysis tool for organizing and aggregating data in a tabular format.',
    pivotTableCompKeywords: 'pivot table, data, analysis, aggregation',

    funnelChartCompName: 'Funnel Chart',
    funnelChartCompDesc:
      'A visualization tool for displaying the progressive reduction of data as it passes through stages.',
    funnelChartCompKeywords: 'funnel chart, sales, conversions, process',

    gaugeChartCompName: 'Gauge Chart',
    gaugeChartCompDesc:
      'A chart that displays data as a reading on a dial, useful for indicating the status or level of something.',
    gaugeChartCompKeywords: 'gauge chart, metrics, performance, status',

    sankeyChartCompName: 'Sankey Chart',
    sankeyChartCompDesc:
      'A flow diagram in which the width of the arrows is proportional to the flow rate, used to show energy, material, or cost transfers.',
    ...
    radarChartCompDesc:
      'A graphical method of displaying multivariate data in the form of a two-dimensional chart of three or more quantitative variables.',
    ...
    graphChartCompDesc:
      'A diagram representing a network of nodes connected by edges, useful for showing interconnections and relationships.',
    graphChartCompKeywords: 'graph chart, networks, relationships, nodes',

    treeChartCompName: 'Tree Chart',
    treeChartCompDesc:
      'A diagram that visually represents hierarchy in a tree-like structure, showing relationships among various nodes.',
    treeChartCompKeywords: 'tree chart, hierarchy, organizational',

    treemapChartCompName: 'Treemap Chart',
    treemapChartCompDesc:
      'A chart that uses nested rectangles to represent hierarchical data proportionately.',
    treemapChartCompKeywords: 'treemap, hierarchy, data visualization',

    sunburstChartCompName: 'Sunburst Chart',
    sunburstChartCompDesc:
      'A radial space-filling visualization technique that illustrates hierarchical relationships through layers of a circle.',
    ...
    themeriverChartCompDesc:
      'A visualization resembling a stream graph that shows changes in a data set over time across categories.',
    ...
    shapeCompDesc:
      'A collection of geometric shapes for use with diagrams, illustrations, and visualizations.',
    ...
    floatButtonCompDesc:
      'A floating action button for prominent and quick actions.',
    floatButtonCompKeywords: 'float button, action, quick',

    avatarCompName: 'Avatar',
    avatarCompDesc:
      'Displays user avatars or profile images for personalized identification.',
    avatarCompKeywords: 'avatar, profile image, user identification',

    avatarGroupCompName: 'Avatar Group',
    avatarGroupCompDesc:
      'A group of avatars to represent multiple users or entities in a compact and visually appealing way.',
    avatarGroupCompKeywords: 'avatar group, users, entities, compact',

    transferName: 'Transfer',
    transferDesc:
      'Facilitates data transfer between two lists with drag-and-drop functionality.',
    transferKeywords: 'transfer, data, drag-and-drop',

    cardCompName: 'Content Card',
    cardCompDesc:
      'A card component for displaying organized information or content in a structured manner.',
    cardCompKeywords: 'card, information, content, display',

    timerCompName: 'Timer',
    timerCompDesc:
      'A component that displays a countdown or elapsed time, useful for tracking durations and deadlines.',
    timerCompKeywords:
      'timer, countdown, elapsed time, tracking, durations, deadlines',
  },
  ...
  customComp: {
    ...
    updateText:
      "I'm Also in a Good Mood to Develop now my own Custom Component with Lowcoder!",
  ...
  richTextEditor: {
    ...
    toolbarDescription:
      'You can customize the toolbar. Please refer to: https://quilljs.com/docs/modules/toolbar/ for more details.',
  ...
  floatButton: {
    ...
    visibilityHeightDesc:
      'Scroll to a certain height before displaying the return to top button, 0 is always displayed,Editing mode cannot preview in real-time',
  },
  ...
  gantt: {
    ...
    addTaskFail:
      'The addition task failed, and the parameter type should be an object or an array object',
    addLinkFail:
      'The addition link failed, and the parameter type should be an object or an array object',
    removeTaskFail:
      'The deletion task failed, and the parameter type should be string or string array',
    removeLinkFail:
      'The deletion links failed, and the parameter type should be string array',
  ...
  avatarComp: {
    ...
    src: 'src',
    avatarCompTooltip:
      'The display priority is: image -> characters -> icon. Depending on what is first available.',
    iconSize: 'Icon Size',
  ...
  stepOptionsControl: {
    value: 'Value / Key',
    valueTooltip:
      'Step Value must be a number. For the first Step, it must be equal to the initial value. Numbers must be in consistent and ascending order',
    title: 'Step Title',
  ...
  step: {
    ...
    initialValueTooltip:
      'Where to start the visual Numbering. Must be 1 or higher.',
  ...
  file: {
    ...
    minSize: 'Min Size',
    minSizeTooltip:
      "The Minimum Size of Uploaded Files with Optional File Size Units (e.g., '5kb', '10 MB'). If No Unit Is Provided, the Value Will Be Considered a Number of Bytes.",
    maxSize: 'Max Size',
    maxSizeTooltip:
      "The Maximum Size of Uploaded Files with Optional File Size Units (e.g., '5kb', '10 MB'). If No Unit Is Provided, the Value Will Be Considered a Number of Bytes.",
    single: 'Single',
    multiple: 'Multiple',
    directory: 'Directory',
    upload: 'Browse',
  ...
  table: {
    ...
    visibleResizablesTooltip:
      'Display visible Resize Handles in the Table Header.',
    ...
    cellColorDesc:
      'Conditionally Set the Cell Color Based on the Cell Value Using CurrentCell. For Example: \'{{ currentCell == 3 ? "green" : "red" }}\'',
    saveChangesNotBind:
  ...
  image: {
    src: 'Image Source',
    srcDesc:
      'The Image Source. Can be an URL, Path or Base64 String. for Example: data:image/png;base64, AAA... CCC',
  ...
  QRCode: {
    ...
    levelTooltip:
      "Refers to the QR Code's Ability to Be Scanned Even if Part of It is Blocked. The Higher the Level, the More Complex the Code.",
  ...
  audio: {
    ...
    loop: 'Loop',
    srcDesc:
      'Current Audio URI or Base64 String like data:audio/mpeg;base64,AAA... CCC',
    play: 'Play',
  ...
  video: {
    ...
    srcDesc:
      'Current Audio URI or Base64 String like data:video/mp4;base64, AAA... CCC',
    play: 'Play',
  ...
  millisecondsControl: {
    timeoutTypeError:
      'Please Enter the Correct Timeout Period in ms, the Current Input is: {value}',
    timeoutLessThanMinError:
      'Input Must Be Greater Than {left}, the Current Input is: {value}',
  },
  selectionControl: {
    single: 'Single',
    multiple: 'Multiple',
  ...
  memberSettings: {
    ...
    memberOrgRoleInfo:
      'Members Can Only Use or Visit Resources They Have Access To.',
    title: 'Members',
  ...
  listView: {
    noOfRows: 'Row Count',
    noOfRowsTooltip:
      "Number of Rows in the List - Usually Set to a Variable (e.g., '{{query1.data.length}}') to Present Query Results",
    noOfColumns: 'Column Count',
    itemIndexName: 'Data Item Index Name',
    itemIndexNameDesc:
      "The Variable Name Referring to the Item's Index, Default as {default}",
    itemDataName: 'Data Item Object Name',
    itemDataNameDesc:
      "The Variable Name Referring to the Item's Data Object, Default as {default}",
    itemsDesc: 'Exposing Data of Components in List',
    dataDesc: 'The JSON Data Used in the Current List',
    dataTooltip:
      'If You just Set a Number, This Field Will Be Regarded as Row Count, and the Data Will Be Regarded as Empty.',
  },
  navigation: {
    ...
    horizontalAlignment: 'Horizontal Alignment',
    logoURLDesc:
      'You can display a Logo on the left side by entering URI Value or Base64 String like data:image/png;base64,AAA... CCC',
  ...
  iframe: {
    URLDesc:
      "The Source URL for the IFrame Content. Make sure the URL is HTTPS or localhost. Also make sure the URL is not blocked by the browser's Content Security Policy (CSP). The header 'X-Frame-Options' should not be set to 'DENY' or 'SAMEORIGIN'.",
  ...
  transformer: {
    ...
    documentationText:
      'Transformers are designed for data transformation and reuse of your multi-line JavaScript code. Use Transformers to adapt Data from queries or components to your local App needs. Unlike JavaScript query, transformer is designed to do read-only operations, which means that you cannot trigger a query or update a temporary state inside a transformer.',
  },
  temporaryState: {
    value: 'Init Value',
    valueTooltip:
    ...
    documentationText:
      'Temporary states are a powerful feature used to manage complex variables that dynamically update the state of components in your application. These states act as intermediary or transient storage for data that can change over time due to user interactions or other processes.',
  },
  dataResponder: {
    data: 'Data',
  ...
  advanced: {
    ...
    AuthOrgDescrition:
      'The URL for Your Users to Sign In to the Current Workspace.',
    APIConsumption: 'API Consumption',
    APIConsumptionDescription:
      'Here you can see the API Consumption for All Apps in the Current Workspace.',
  ...
  module: {
    ...
    documentationText:
      'Modules are complete Applications, that can get included and repeated in other Applications and it functions just like a single component. As modules can get embedded, they need to be able to interact with your outside apps or websites. This four settings help to support communication with a Module.',
    circularReference:
  ...
  aggregation: {
    ...
    iconTooltip:
      'Support Image src Link or Base64 String like data:image/png;base64,AAA... CCC',
  ...
  profile: {
    ...
    saveUserNameTooltip:
      'Hit Enter to Save your new NicName. If you see your Email, it means that we just hijacked it as Username and you can change it to a better one. Your Email as technical username stays untouched.',
  ...
  editorTutorials: {
    component: 'Component',
    componentContent:
      'The Right Component Panel offers you many ready made Application Blocks (Components). These Can Be Dragged onto the Canvas for Use. You Can Also Create Your Own Components with a little coding knowledge.',
    canvas: 'Canvas',
    canvasContent:
    ...
    queryDataContent:
      "You can create Data Queries Here and Connect to Your MySQL, MongoDB, Redis, Airtable, and many Other Data Sources. After Configuring the Query, Click 'Run' to Obtain the Data and continue the Tutorial.",
    compProperties: 'Component Properties',
  },
  homeTutorials: {
    createAppContent:
      "Welcome! Click 'App' and Start to Create Your First Application.",
  ...
  home: {
    ...
    appMarketplaceMessage:
      'Publish your App on the Public Marketplace. Anyone can view and copy it from there.',
    moduleMarketplaceMessage:
      'Publish your Module on the Public Marketplace. Anyone can view and copy it from there.',
    marketplaceGoodPublishing:
      'Please make sure your app is well-named and easy to use. Remove any sensitive information before publishing. Also, remove local datasources and replace by static built-in temporary data.',
  ...
  playground: {
    ...
    methodParamsHelp:
      "Input Method Parameters Using JSON. For Example, You Can Set setValue's Parameters With: [1] or 1",
  },
  calendar: {
  ...
  timeLine: {
    ...
    pendingDescription:
      'When Set, Then a Last Node With the Text and a Waiting Indicator Will Be Displayed.',
  ...
  tour: {
    ...
    options: {
      ...
      mask: {
        ...
        tooltipValidTypes:
          'Valid input types: `true`, `false`, empty, or a JSON object following the CSSProperties Schema from Antd.',
      },
      arrow: {
        label: 'Arrow',
        tooltip:
          'Turns the arrow on and off or moves it to point at the center of the component, if desired, otherwise the arrow will always point near the top of the component.',
        tooltipFunctionSignature: 'boolean | { pointAtCenter: boolean }',
      },
      type: {
        label: 'Type',
        tooltip:
          'The type of tooltip, this affects the background color and text color. The colors can be controlled with the main tour styling section.',
      },
      target: {
        label: 'Component',
        tooltip:
          'The component you want to put the tooltip on, or leave it empty if you simply want a modal in the middle of the screen.',
      },
      coverImage: {
    ...
    indicatorsRender: {
      ...
      tooltipValidTypes:
        'Format is a function that accepts two args, `current` and `total` and returns a ReactNode',
    ...
    mask: {
      label: 'Mask',
      tooltip:
        'Whether to enable masking, change mask style and fill color by pass custom props, the default follows the `mask` property of Tour. Can be overridden at the step level.',
      tooltipValidTypes:
        'Valid input types: `true`, `false`, empty, or a JSON object following the CSSProperties Schema from Antd.',
    },
    placement: {
      label: 'Placement',
      tooltip:
        'Position of the guide card relative to the target element. Can be overridden at the step level.',
    ...
    arrow: {
      label: 'Arrow',
      tooltip:
        'Turns the arrow on and off or moves it to point at the center of the component, if desired, otherwise the arrow will always point near the top of the component. Can be overridden at the step level.',
      tooltipFunctionSignature: 'boolean | { pointAtCenter: boolean }',
    },
    type: {
      label: 'Type',
      tooltip:
        'The type of tooltip, this affects the background color and text color. The colors can be controlled with the main tour styling section. Can be overridden at the step level.',
    },
  },
