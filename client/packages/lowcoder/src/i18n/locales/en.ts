...
export const en = {
  ...
  prop: {
    ...
    showAppTooltip:
      "You can display whole Lowcoder Apps in the content area. Please mind, that for Modules we do not support Inputs, Outputs Events and Methods.",
  ...
  homeTutorials: {
    // eslint-disable-next-line only-ascii/only-ascii
    createAppContent:
      "🎉 Welcome to {productName}, Click 'App' and Start to Create Your First Application.",
  ...
  home: {
    ...
    appMarketplaceMessage:
      "Publish your App on Lowcoder Marketplace. Anyone can view and copy it from there.",
    moduleMarketplaceMessage:
      "Publish your Module on Lowcoder Marketplace. Anyone can view and copy it from there.",
