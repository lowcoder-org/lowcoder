...
export const en = {
  ...
  "style": {
    ...
    // Chat Box Styles
    "chatSidebarBackground": "Background",
    "chatSidebarText": "Text",
    "chatSidebarBorder": "Border",
    "chatSidebarHeaderBackground": "Header BG",
    "chatActiveItemBackground": "Active BG",
    "chatActiveItemText": "Active Text",
    "chatSidebarItemPadding": "Item Padding",
    "chatSidebarRadius": "Radius",
    "chatHeaderBackground": "Background",
    "chatHeaderText": "Text",
    "chatHeaderBorder": "Border",
    "chatHeaderPadding": "Padding",
    "chatMessageAreaBackground": "Area BG",
    "chatMessageAreaPadding": "Area Padding",
    "chatOwnMessageBackground": "Own Msg BG",
    "chatOwnMessageText": "Own Msg Text",
    "chatOtherMessageBackground": "Other Msg BG",
    "chatOtherMessageText": "Other Msg Text",
    "chatAiMessageBackground": "AI Msg BG",
    "chatAiMessageText": "AI Msg Text",
    "chatAiMessageBorder": "AI Msg Border",
    "chatAvatarBackground": "Avatar BG",
    "chatAvatarText": "Avatar Text",
    "chatAvatarBorderWidth": "Avatar Border Width",
    "chatAvatarBorderStyle": "Avatar Border Style",
    "chatAvatarBorder": "Avatar Border",
    "chatMessageBubblePadding": "Bubble Padding",
    "chatMessageBubbleRadius": "Bubble Radius",
    "chatMessageMetaText": "Meta Text",
    "chatInputFieldBackground": "background",
    "chatInputText": "text",
    "chatInputFieldBorder": "border",
    "chatInputFieldRadius": "radius",
    "chatInputFieldPadding": "padding",
    "chatInputAreaBackground": "background",
    "chatInputAreaBorder": "border",
    "chatInputAreaPadding": "padding",
    "chatInputPlaceholder": "Placeholder text",
    "chatSendButtonBackground": "background",
    "chatSendButtonIcon": "icon",
    "chatSendButtonRadius": "radius",
    "chatAttachButtonIcon": "icon",
    "chatAttachButtonRadius": "radius",
    "chatAttachButtonHoverBackground": "hover",
  ...
  "query": {
    ...
    "triggerTypeBeforeUnload": "Before the Application unloads",
  ...
  "chatBox": {
    "messageSent": "Message Sent",
    "messageSentDesc": "Triggered when the user presses send. Read chatBox.lastSentMessageText and chatBox.lastSentMessageTagsLlm. Mentions are plain @DisplayName in the text; lastSentMessageTagsLlm is true when the AI label (e.g. from chatBox.aiShortLabel) is @-mentioned. Legacy @[Name](u:id) in old messages is still parsed for assistant bubbles.",
    "startTyping": "Start Typing",
    "startTypingDesc": "Triggered when the user starts typing. Wire this to chatController.startTyping().",
    "stopTyping": "Stop Typing",
    "stopTypingDesc": "Triggered when the user stops typing. Wire this to chatController.stopTyping().",
    "roomSwitch": "Room Switch",
    "roomSwitchDesc": "User clicked a room they are already a member of. Read chatBox.pendingRoomId, then call chatController.switchRoom with that room ID.",
    "roomJoin": "Room Join",
    "roomJoinDesc": "User wants to join a room from search results. Read chatBox.pendingRoomId, then call chatController.joinRoom with that room ID.",
    "roomLeave": "Room Leave",
    "roomLeaveDesc": "User clicked leave on a room. Read chatBox.pendingRoomId, then call chatController.leaveRoom with that room ID.",
    "roomCreate": "Room Create",
    "roomCreateDesc": "User submitted the create-room form. Read chatBox.newRoomName, newRoomType, newRoomDescription, newRoomLlmQuery, then call chatController.createRoom(...).",
    "inviteSend": "Invite Send",
    "inviteSendDesc": "User sent a room invite. Read chatBox.inviteTargetUserId, then call chatController.sendInvite with the current room ID and that user ID.",
    "inviteAccept": "Invite Accept",
    "inviteAcceptDesc": "User accepted a pending invite. Read chatBox.pendingInviteId, then call chatController.acceptInvite with that invite ID.",
    "inviteDecline": "Invite Decline",
    "inviteDeclineDesc": "User declined a pending invite. Read chatBox.pendingInviteId, then call chatController.declineInvite with that invite ID.",
    "fileUpload": "File Upload",
    "fileUploadDesc": "Triggered when the user adds a file in the message input. Read chatBox.files and chatBox.value (base64), same as the File component.",
    "openMessageFilePickerDesc": "Opens the native file picker for message attachments (same as the paperclip). Does nothing if file upload is disabled or the maximum attachment count is already reached.",
    "chatTitleDefault": "Chat",
    "currentUserNameDefault": "User",
    "chatTitleLabel": "Chat Title",
    "chatTitleTooltip": "Display title shown in the chat header",
    "messagesLabel": "Messages",
    "messagesTooltip": "Bind to your data query, such as loadMessages.data. Expected fields include id, text, authorId, authorName, and timestamp.",
    "currentUserIdLabel": "Current User ID",
    "currentUserIdTooltip": "The current user's ID, used to distinguish own vs. other messages. Bind it to chatController1.userId.",
    "currentUserNameLabel": "Current User Name",
    "currentUserNameTooltip": "The current user's display name",
    "mentionCandidatesLabel": "Mention candidates",
    "mentionCandidatesTooltip": "Optional array for the @ mention picker. Each item must include id and label, e.g. '{{ \"id\": \"user_1\", \"label\": \"Alice\" }}'. When set, all entries are users and the AI mention is appended. Leave empty to use room members and online users.",
    "roomsPanelSection": "Rooms Panel",
    "showRoomsPanelLabel": "Show Rooms Panel",
    "panelWidthLabel": "Panel Width",
    "panelWidthTooltip": "Width of the rooms sidebar, e.g. 240px or 30%",
    "roomsLabel": "Rooms",
    "roomsTooltip": "Bind to chatController1.userRooms, the list of rooms visible to the current user.",
    "currentRoomIdLabel": "Current Room ID",
    "currentRoomIdTooltip": "Bind to chatController1.currentRoomId to highlight the active room.",
    "pendingInvitesLabel": "Pending Invites",
    "pendingInvitesTooltip": "Bind to chatController1.pendingInvites to show invite notifications.",
    "allowRoomCreationLabel": "Allow Room Creation",
    "allowRoomSearchLabel": "Allow Room Search",
    "realTimeSection": "Real-time",
    "typingUsersLabel": "Typing Users",
    "typingUsersTooltip": "Array of users currently typing. Bind to chatController1.typingUsers.",
    "aiIsThinkingLabel": "AI Is Thinking",
    "aiIsThinkingTooltip": "Show the AI thinking animation to all users in this room. Bind to the current room value from chatController1.aiThinkingRooms.",
    "onlineUsersLabel": "Online Users",
    "onlineUsersTooltip": "Array of online users with presence. Bind to chatController1.onlineUsers. Each item includes userId, userName, and currentRoomId.",
    "displaySection": "Display",
    "showHeaderLabel": "Show Header",
    "attachmentsSection": "Message attachments",
    "allowMessageFileUploadLabel": "Allow file upload",
    "allowMessageFileUploadTooltip": "Show a paperclip control next to the message field to attach files before sending.",
    "maxMessageFilesLabel": "Max attachments",
    "maxMessageFilesTooltip": "Maximum number of files kept in the input at once (same order as File component value/files).",
    "messageFileTypeLabel": "Accepted file types",
    "messageFileTypeTooltip": "Optional list of extensions or MIME patterns, e.g. [\".png\",\"application/pdf\"]. Leave empty to allow all types.",
    "messageFilesValueExposed": "Base64-encoded contents of files selected in the message input (aligned with File component value). Cleared after send.",
    "messageFilesMetaExposed": "Metadata for files in the message input: uid, name, type, size, lastModified (aligned with File component files). Cleared after send.",
    "attachFileTooltip": "Attach file",
    "openAttachment": "Open attachment: {name}",
    "emptyMessagePlaceholder": "(No message text)",
    "sidebarStyleSection": "Sidebar Style",
    "headerStyleSection": "Header Style",
    "messageAreaStyleSection": "Message Area Style",
    "messageStyleSection": "Message Style",
    "avatarStyleSection": "Message Avatar Style",
    "ownMessageStyle": "Own Message",
    "otherMessageStyle": "Other Message",
    "aiMessageStyle": "AI Message",
    "ownAvatarStyle": "Own Avatar",
    "otherAvatarStyle": "Other Avatar",
    "aiAvatarStyle": "AI Avatar",
    "inputAreaStyleSection": "Input area",
    "inputFieldStyleSection": "Input field",
    "inputSendButtonStyleSection": "Send button",
    "inputAttachButtonStyleSection": "Attachment button",
    "chatTitleExposed": "Chat display title",
    "lastSentMessageTextExposed": "Text of the last message sent by the user — use in your save query",
    "lastSentMessageTagsLlmExposed": "True if the last sent message @-mentioned the AI — use to decide whether to run the room LLM query",
    "messageTextExposed": "Current text in the message input",
    "currentRoomIdExposed": "Currently active room ID — for AI thinking or room-scoped queries",
    "pendingRoomIdExposed": "Room ID the user wants to switch to, join, or leave — read in roomSwitch/roomJoin/roomLeave events",
    "newRoomNameExposed": "Name entered in the create-room form",
    "newRoomTypeExposed": "Type selected in the create-room form: public | private | llm",
    "newRoomDescriptionExposed": "Description entered in the create-room form",
    "newRoomLlmQueryExposed": "Query name entered for LLM rooms in the create-room form",
    "inviteTargetUserIdExposed": "User ID entered in the invite form — read in inviteSend event",
    "pendingInviteIdExposed": "Invite ID the user accepted or declined — read in inviteAccept/inviteDecline events",
    "onlineCount": "{count} online",
    "typeMessagePlaceholder": "Type a message… Use @ to mention someone or the AI",
    "mentionNoMatches": "No matching people",
    "mentionLlmBadge": "AI",
    "joinRoomTitle": "Join \"{roomName}\"",
    "aiShortLabel": "AI",
    "joinAction": "Join",
    "leaveRoomConfirm": "Leave \"{roomName}\"?",
    "leaveAction": "Leave",
    "cancelAction": "Cancel",
    "roomsHeader": "Rooms",
    ...
    "noRoomsYetCreateOne": "No rooms yet. Create one!",
    "aiRoomsLabel": "AI Rooms",
    "publicRoomsLabel": "Public",
    "privateRoomsLabel": "Private",
    "onlinePresence": "Online — {count}",
    "userWithYou": "{userName} (You)",
    "createRoomModalTitle": "Create Room",
    "roomTypeLabel": "ROOM TYPE",
    "normalRoomLabel": "Normal Room",
    "aiRoomLabel": "AI / LLM Room",
    "aiRoomStrongLabel": "AI Room",
    "aiRoomMessage": "— run your Lowcoder query only when the user @-mentions the AI in a message. The AI reply is broadcast to all members in real time.",
    "roomNameLabel": "Room Name",
    "roomNameRequired": "Room name is required",
    "roomNameMin": "At least 2 characters",
    "roomNameMax": "At most 50 characters",
    "roomNamePlaceholderAi": "e.g. GPT-4 Assistant",
    "roomNamePlaceholderNormal": "e.g. Design Team",
    "descriptionLabel": "Description",
    "descriptionPlaceholder": "What is this room about?",
    "visibilityLabel": "Visibility",
    "queryNameLabel": "Query Name",
    "queryNameHint": "name of your Lowcoder query",
    "queryNameRequired": "A query name is required for AI rooms",
    "queryNameExtraPrefix": "Create a query in the bottom panel of Lowcoder and enter its exact name here. Your query will receive",
    "queryNameExtraSuffix": "as arguments.",
    "queryNamePlaceholder": "e.g. getAIResponse",
    "createAiRoomButton": "Create AI Room",
    "createRoomButton": "Create Room",
    "inviteUserTitle": "Invite User",
    "invitesPrivateOnly": "Invites are available only in private rooms.",
    "sendingInviteFor": "Sending invite for {roomName}",
    "inviteUserIdLabel": "User ID",
    "inviteUserIdRequired": "User ID is required",
    "inviteUserIdPlaceholder": "e.g. user_42",
    "inviteUserNameOptionalLabel": "User Name (optional)",
    "inviteUserNamePlaceholder": "e.g. Sarah",
    ...
    "singleUserTyping": "{userName} is typing...",
    "multipleUsersTyping": "{count} people are typing...",
    "someoneLabel": "Someone"
  },
  "chatController": {
    "userJoined": "User Joined",
    "userJoinedDesc": "A user came online in this application",
    "userLeft": "User Left",
    "userLeftDesc": "A user went offline",
    "roomSwitched": "Room Switched",
    "roomSwitchedDesc": "Active room changed. Read currentRoomId.",
    "connected": "Connected",
    "connectedDesc": "Connected to the chat controller",
    "disconnected": "Disconnected",
    "disconnectedDesc": "Disconnected from the chat controller",
    "error": "Error",
    "errorDesc": "A connection error occurred",
    "aiThinkingStarted": "AI Thinking Started",
    "aiThinkingStartedDesc": "The AI assistant started generating a response in a room",
    "aiThinkingStopped": "AI Thinking Stopped",
    "aiThinkingStoppedDesc": "The AI assistant finished (or was cancelled) in a room",
    "sharedStateChanged": "Shared State Changed",
    "sharedStateChangedDesc": "The app-level shared state was updated by any user. Read chatController.sharedState to get the current state.",
    "roomDataChanged": "Room Data Changed",
    "roomDataChangedDesc": "Room-scoped shared data was updated by any user. Read chatController.roomData to get the current data.",
    ...
    "applicationIdTooltip": "Scopes the signal room to this application. All users of the same app share presence and notifications.",
    "userIdLabel": "User ID",
    "userIdTooltip": "Current user's unique identifier",
    "userNameLabel": "User Name",
    "userNameTooltip": "Current user's display name",
    "readyExposed": "Whether the chat controller is connected and ready",
    "errorExposed": "Error message if connection failed",
    "connectionStatusExposed": "Current connection status (Online / Connecting... / Offline)",
    "onlineUsersExposed": "Array of currently online users, including userId, userName, and currentRoomId.",
    "typingUsersExposed": "Array of users currently typing, including userId, userName, and roomId.",
    "currentRoomIdExposed": "Currently active room/channel ID",
    "userIdExposed": "Current user ID",
    "userNameExposed": "Current user name",
    "applicationIdExposed": "Application scope ID",
    "aiThinkingRoomsExposed": "Map of room IDs to boolean values showing which rooms currently have an AI thinking.",
    "sharedStateExposed": "App-level shared state in JSON form that auto-syncs across all connected users. Write to it with setSharedState.",
    "roomDataExposed": "Room-scoped shared data in JSON form that auto-syncs. It is not visible as chat messages. Write to it with setRoomData.",
    "startTypingMethodDesc": "Signal that the current user started typing. Other users will see the typing indicator.",
    "stopTypingMethodDesc": "Signal that the current user stopped typing",
    "switchRoomMethodDesc": "Set the current room/channel context. Presence and typing will scope to this room.",
    "setAiThinkingMethodDesc": "Broadcast to all room members that the AI assistant is thinking (or has finished). All users in the room will see the thinking indicator.",
    "setSharedStateMethodDesc": "Set a key-value pair in the app-level shared state. Auto-syncs to all connected users instantly via CRDT.",
    "deleteSharedStateMethodDesc": "Delete a key from the app-level shared state.",
    "setRoomDataMethodDesc": "Set a key-value pair in a room's shared data. Auto-syncs to all connected users. Not visible as a chat message — use for real-time JSON data exchange within a room/channel.",
    "deleteRoomDataMethodDesc": "Delete a key from a room's shared data. If no key is provided, deletes all data for the room.",
    "setUserMethodDesc": "Update the current user credentials"
  },
  ...
  "dropdown": {
    ...
    "onlyIcon": "Trigger Icon Only",
    "triggerIcon": "Trigger Icon",
    "triggerIconSize": "Trigger Icon Size (px)",
    "textDesc": "Text Currently Displayed on Button",
  ...
  "environments": {
    ...
    "licenseStatus_checking": "Checking...",
    "licenseStatus_licensed": "Licensed",
    "licenseStatus_unlicensed": "License Required",
    "licenseStatus_error": "Setup Required",
    "licenseStatus_unknown": "Unknown",
    "detail_environmentNotFound": "Environment Not Found",
    "detail_returnToEnvironmentsList": "Return to Environments List",
    "detail_environmentDetail": "Environment Detail",
    "detail_environmentOverview": "Environment Overview",
    "detail_noDomainSet": "No domain set",
    "detail_environmentId": "Environment ID",
    "detail_licenseStatus": "License Status",
    "detail_licenseNeeded": "License Needed",
    "detail_setupRequired": "Setup Required",
    "detail_created": "Created",
    "detail_unknown": "Unknown",
    "detail_licenseDetails": "License Details",
    "detail_apiCallsRemaining": "API Calls Remaining",
    "detail_totalApiCallsLimit": "Total API Calls Limit",
    "detail_enterpriseEdition": "Enterprise Edition",
    "detail_active": "Active",
    "detail_inactive": "Inactive",
    "detail_licenseInformation": "License Information",
    "detail_calls": "calls",
    "detail_licenses": "Licenses",
    "detail_license": "License",
    "detail_workspaces": "Workspaces",
    "detail_userGroups": "User Groups",
    "detail_type": "Type",
    "detail_status": "Status",
    "detail_licensed": "Licensed",
    "detail_unlicensed": "Unlicensed",
    "detail_apiKey": "API Key",
    "detail_configured": "Configured",
    "detail_notSet": "Not Set",
    "detail_masterEnv": "Master Env",
    "unlicensed_unlicensedDescription": "This environment needs a valid license to unlock its full capabilities and features. Please make sure your API Service URL is correctly configured and Plugin is installed.",
    "unlicensed_errorDescription": "We encountered an issue while checking the license. Please review the configuration settings.",
    "unlicensed_defaultDescription": "This environment requires license configuration to proceed.",
    "unlicensed_contactLowcoderTeam": "Contact Lowcoder Team",
    "unlicensed_editEnvironment": "Edit Environment",
    "unlicensed_backToEnvironments": "Back to Environments",
    "unlicensed_helpText": "Need assistance? Contact our team for licensing support or edit the environment configuration to resolve this issue.",
    "unlicensed_type": "Type",
    "unlicensed_status": "Status",
    "unlicensed_masterEnv": "Master Env",
    "unlicensed_licenseIssue": "License Issue",
    "unlicensed_error": "Error",
    "unlicensed_missing": "Missing",
    "error_itemNotFound": "The item you're looking for doesn't exist or you don't have permission to view it.",
    "modal_createNewEnvironment": "Create New Environment",
    "modal_editEnvironment": "Edit Environment",
    "modal_cancel": "Cancel",
    "modal_createEnvironment": "Create Environment",
    "modal_saveChanges": "Save Changes",
    "modal_environmentName": "Environment Name",
    "modal_pleaseEnterName": "Please enter a name",
    "modal_nameMinLength": "Name must be at least 2 characters",
    "modal_enterEnvironmentName": "Enter environment name",
    "modal_description": "Description",
    "modal_enterDescription": "Enter description",
    "modal_stage": "Stage",
    "modal_pleaseSelectStage": "Please select a stage",
    "modal_selectStage": "Select stage",
    "modal_development": "Development (DEV)",
    "modal_testing": "Testing (TEST)",
    "modal_preProduction": "Pre-Production (PREPROD)",
    "modal_production": "Production (PROD)",
    "modal_frontendUrl": "Frontend URL",
    "modal_pleaseEnterValidUrl": "Please enter a valid URL",
    "modal_apiServiceUrl": "API Service URL",
    "modal_nodeServiceUrl": "Node Service URL",
    "modal_apiKey": "API Key",
    "modal_enterApiKey": "Enter API key",
    "modal_masterEnvironment": "Master Environment",
    "modal_alreadyMasterEnvironment": "{name} is already the Master environment",
    "modal_willBeMaster": "Will be Master",
    "modal_currentlyMaster": "Currently Master",
    "modal_configurationRequirements": "Configuration Requirements",
    "modal_configurationRequirementsDesc": "Ensure that the API Service URL is configured and correct, the API key is valid, and for license verification make sure you have both the license and plugin properly installed.",
    "workspaces_title": "Workspaces",
    "workspaces_subtitle": "Manage workspaces in this environment",
    "workspaces_refresh": "Refresh",
    "workspaces_errorLoadingWorkspaces": "Error loading workspaces",
    "workspaces_configurationIssue": "Configuration Issue",
    "workspaces_missingConfiguration": "Missing required configuration: API key or API service URL",
    "workspaces_totalWorkspaces": "Total Workspaces",
    "workspaces_managedWorkspaces": "Managed Workspaces",
    "workspaces_unmanagedWorkspaces": "Unmanaged Workspaces",
    "workspaces_workspace": "Workspace",
    "workspaces_role": "Role",
    "workspaces_status": "Status",
    "workspaces_managed": "Managed",
    "workspaces_unmanaged": "Unmanaged",
    "workspaces_actions": "Actions",
    "workspaces_viewAuditLogs": "View Audit Logs",
    "workspaces_audit": "Audit",
    "workspaces_searchWorkspaces": "Search workspaces by name or ID",
    "workspaces_showAll": "Show All",
    "workspaces_managedOnly": "Managed Only",
    "workspaces_showingResults": "Showing {count} of {total} workspaces",
    "workspaces_paginationTotal": "{start}-{end} of {total} workspaces",
    "workspaces_noWorkspacesFound": "No workspaces found in this environment",
    "userGroups_title": "User Groups",
    "userGroups_subtitle": "Manage user groups in this environment",
    "userGroups_refresh": "Refresh",
    "userGroups_errorLoadingUserGroups": "Error loading user groups",
    "userGroups_configurationIssue": "Configuration Issue",
    "userGroups_missingConfiguration": "Missing required configuration: API key or API service URL",
    "userGroups_totalGroups": "Total Groups",
    "userGroups_allUsersGroups": "All Users Groups",
    "userGroups_developerGroups": "Developer Groups",
    "userGroups_customGroups": "Custom Groups",
    "userGroups_userGroup": "User Group",
    "userGroups_type": "Type",
    "userGroups_allUsers": "All Users",
    "userGroups_developers": "Developers",
    "userGroups_custom": "Custom",
    "userGroups_members": "Members",
    "userGroups_adminMembers": "Admin Members",
    "userGroups_created": "Created",
    "userGroups_totalMembersTooltip": "Total number of members in this group",
    "userGroups_adminMembersTooltip": "Number of admin users in this group",
    "userGroups_searchUserGroups": "Search user groups by name or ID",
    "userGroups_showingResults": "Showing {count} of {total} user groups",
    "userGroups_paginationTotal": "{start}-{end} of {total} user groups",
    "userGroups_noUserGroupsFound": "No user groups found in this environment",
    "apps_title": "Apps",
    "apps_subtitle": "Manage workspace applications",
    "apps_refresh": "Refresh",
    "apps_errorLoadingApps": "Error loading apps",
    "apps_configurationIssue": "Configuration Issue",
    "apps_missingConfiguration": "Missing required configuration: API key or API service URL",
    "apps_totalApps": "Total Apps",
    "apps_publishedApps": "Published Apps",
    "apps_managedApps": "Managed Apps",
    "apps_unmanagedApps": "Unmanaged Apps",
    "apps_app": "App",
    "apps_status": "Status",
    "apps_published": "Published",
    "apps_draft": "Draft",
    "apps_managed": "Managed",
    "apps_unmanaged": "Unmanaged",
    "apps_deploy": "Deploy",
    "apps_audit": "Audit",
    "apps_appMustBeManagedToDeploy": "App must be managed before it can be deployed",
    "apps_deployThisApp": "Deploy this app to another environment",
    "apps_viewAuditLogs": "View Audit Logs",
    "apps_searchApps": "Search apps by name or ID",
    "apps_showAll": "Show All",
    "apps_managedOnly": "Managed Only",
    "apps_showingResults": "Showing {count} of {total} apps",
    "apps_paginationTotal": "{start}-{end} of {total} apps",
    "apps_noAppsFound": "No apps found in this workspace",
    "apps_appRecycled": "This app has been moved to recycle bin",
    "apps_managedSuccess": "{name} is now Managed",
    "apps_unmanagedSuccess": "{name} is now Unmanaged",
    "apps_managedError": "Failed to change managed status for {name}",
    "dataSources_title": "Data Sources",
    "dataSources_subtitle": "Manage workspace data connections",
    "dataSources_refresh": "Refresh",
    "dataSources_errorLoadingDataSources": "Error loading data sources",
    "dataSources_configurationIssue": "Configuration Issue",
    "dataSources_missingConfiguration": "Missing required configuration: API key or API service URL",
    "dataSources_totalDataSources": "Total Data Sources",
    "dataSources_availableTypes": "Available Types",
    "dataSources_managed": "Managed",
    "dataSources_unmanaged": "Unmanaged",
    "dataSources_dataSource": "Data Source",
    "dataSources_type": "Type",
    "dataSources_status": "Status",
    "dataSources_deploy": "Deploy",
    "dataSources_audit": "Audit",
    "dataSources_dataSourceMustBeManagedToDeploy": "Data source must be managed before it can be deployed",
    "dataSources_deployThisDataSource": "Deploy this data source to another environment",
    "dataSources_viewAuditLogs": "View Audit Logs",
    "dataSources_searchDataSources": "Search data sources by name or ID",
    "dataSources_showAll": "Show All",
    "dataSources_managedOnly": "Managed Only",
    "dataSources_showingResults": "Showing {count} of {total} data sources",
    "dataSources_paginationTotal": "{start}-{end} of {total} data sources",
    "dataSources_noDataSourcesFound": "No data sources found in this workspace",
    "dataSources_managedSuccess": "{name} is now Managed",
    "dataSources_unmanagedSuccess": "{name} is now Unmanaged",
    "dataSources_managedError": "Failed to change managed status for {name}",
    "queries_title": "Queries",
    "queries_subtitle": "Manage workspace API queries",
    "queries_refresh": "Refresh",
    "queries_errorLoadingQueries": "Error loading queries",
    "queries_configurationIssue": "Configuration Issue",
    "queries_missingConfiguration": "Missing required configuration: API key or API service URL",
    "queries_totalQueries": "Total Queries",
    "queries_managed": "Managed",
    "queries_unmanaged": "Unmanaged",
    "queries_query": "Query",
    "queries_creator": "Creator",
    "queries_status": "Status",
    "queries_deploy": "Deploy",
    "queries_audit": "Audit",
    "queries_queryMustBeManagedToDeploy": "Query must be managed before it can be deployed",
    "queries_deployThisQuery": "Deploy this query to another environment",
    "queries_viewAuditLogs": "View Audit Logs",
    "queries_searchQueries": "Search queries by name or ID",
    "queries_showAll": "Show All",
    "queries_managedOnly": "Managed Only",
    "queries_showingResults": "Showing {count} of {total} queries",
    "queries_paginationTotal": "{start}-{end} of {total} queries",
    "queries_noQueriesFound": "No queries found in this workspace",
    "queries_managedSuccess": "{name} is now Managed",
    "queries_unmanagedSuccess": "{name} is now Unmanaged",
    "queries_managedError": "Failed to change managed status for {name}",
    
    // Deploy Modal and Credential Confirmations
    "deployModal_deployTitle": "Deploy {singularLabel}: {name}",
    "deployModal_loadingEnvironments": "Loading environments...",
    "deployModal_sourceEnvironment": "Source Environment",
    "deployModal_targetEnvironment": "Target Environment",
    "deployModal_selectTargetEnvironment": "Select target environment",
    "deployModal_selectTargetEnvironmentValidation": "Please select a target environment",
    "deployModal_confirmed": "Confirmed",
    "deployModal_cancel": "Cancel", 
    "deployModal_deploy": "Deploy",
    "deployModal_targetEnvironmentNotFound": "Target environment not found",
    "deployModal_confirmCredentialOverwrite": "Please confirm credential overwrite before deploying",
    "deployModal_deploySuccess": "Successfully deployed {name} to target environment",
    "deployModal_deployFailed": "Failed to deploy {singularLabel}",
    "deployModal_selectFieldValidation": "Please select {label}",
    "deployModal_selectFieldPlaceholder": "Select {label}",
    "deployModal_inputFieldValidation": "Please input {label}",
    "deployModal_inputFieldPlaceholder": "Enter {label}",

    // Add contact lowcoder modal
    "contactLowcoder_title": "Contact Lowcoder Team",
    "contactLowcoder_environmentLabel": "Environment:",
    "contactLowcoder_environmentIdLabel": "Environment ID:",
    "contactLowcoder_deploymentIdLabel": "Deployment ID:",
    "contactLowcoder_loading": "Loading...",
    "contactLowcoder_notAvailable": "Not available",
    "contactLowcoder_unnamedEnvironment": "Unnamed Environment",
    "contactLowcoder_fetchingDeploymentInfo": "Fetching deployment information...",
    "contactLowcoder_unableToLoadContactForm": "Unable to Load Contact Form",
    "contactLowcoder_apiConfigurationError": "Environment API service URL or API key not configured",
    "contactLowcoder_failedToFetchDeploymentId": "Failed to fetch deployment ID",
    "contactLowcoder_ensureProperConfiguration": "Please ensure the environment is properly configured to contact support.",

    "credentialConfirmations_firstConfirmation_title": "Overwrite Credentials Warning",
    "credentialConfirmations_firstConfirmation_message": "This action will overwrite existing credentials in the target environment.",
    "credentialConfirmations_firstConfirmation_description": "This is a serious operation that may affect other applications and users.",
    "credentialConfirmations_firstConfirmation_question": "Are you sure you want to proceed?",
    "credentialConfirmations_firstConfirmation_continueButton": "Continue",
    "credentialConfirmations_firstConfirmation_cancelButton": "Cancel",
    "credentialConfirmations_secondConfirmation_title": "Final Confirmation Required",
    "credentialConfirmations_secondConfirmation_message": "Final Warning: Credential Overwrite",
    "credentialConfirmations_secondConfirmation_description": "You are about to overwrite credentials in the target environment. This action cannot be undone and may break existing integrations.",
    "credentialConfirmations_secondConfirmation_confirmOnceMore": "Please confirm one more time.",
    "credentialConfirmations_secondConfirmation_finalQuestion": "Are you absolutely certain you want to overwrite the credentials?",
    "credentialConfirmations_secondConfirmation_confirmButton": "Yes, Overwrite Credentials",
    "credentialConfirmations_secondConfirmation_cancelButton": "Cancel",

    "config_singularLabels_app": "App",
    "config_singularLabels_dataSource": "Data Source", 
    "config_singularLabels_query": "Query",
    "config_singularLabels_workspace": "Workspace",
    "config_fields_updateDependenciesIfNeeded": "Update Dependencies If Needed",
    "config_fields_publishOnTarget": "Publish On Target",
    "config_fields_publicToAll": "Public To All",
    "config_fields_publicToMarketplace": "Public To Marketplace",
    "config_fields_overwriteCredentials": "Overwrite Credentials",
    
    // Service error messages
    "services_environments_missingEnvironmentId": "Missing environment ID",
    "services_environments_failedToUpdateEnvironment": "Failed to update environment",
    "services_environments_environmentCreatedSuccessfully": "Environment created successfully",
    "services_environments_failedToCreateEnvironment": "Failed to create environment",
    "services_environments_failedToFetchEnvironments": "Failed to fetch environments",
    "services_environments_failedToFetchEnvironment": "Failed to fetch environment",
    "services_environments_environmentIdRequired": "Environment ID is required",
    "services_environments_apiKeyRequiredForWorkspaces": "API key is required to fetch workspaces",
    "services_environments_apiServiceUrlRequiredForWorkspaces": "API service URL is required to fetch workspaces",
    "services_environments_failedToFetchWorkspaces": "Failed to fetch workspaces",
    "services_environments_apiKeyRequiredForUserGroups": "API key is required to fetch user groups",
    "services_environments_apiServiceUrlRequiredForUserGroups": "API service URL is required to fetch user groups",
    "services_environments_failedToFetchUserGroups": "Failed to fetch user groups",
    "services_environments_workspaceIdRequired": "Workspace ID is required",
    "services_environments_apiKeyRequiredForApps": "API key is required to fetch apps",
    "services_environments_apiServiceUrlRequiredForApps": "API service URL is required to fetch apps",
    "services_environments_failedToFetchWorkspaceApps": "Failed to fetch workspace apps",
    "services_environments_apiKeyRequiredForDataSources": "API key is required to fetch data sources",
    "services_environments_apiServiceUrlRequiredForDataSources": "API service URL is required to fetch data sources",
    "services_environments_failedToFetchWorkspaceDataSources": "Failed to fetch workspace data sources",
    "services_environments_apiKeyRequiredForQueries": "API key is required to fetch queries",
    "services_environments_apiServiceUrlRequiredForQueries": "API service URL is required to fetch queries",
    "services_environments_failedToFetchWorkspaceQueries": "Failed to fetch workspace queries",
    "services_environments_apiServiceUrlNotConfigured": "API service URL not configured",
    "services_environments_licenseCheckFailed": "License check failed",
    "services_environments_apiKeyRequiredForDeploymentId": "API key is required to fetch deployment ID",
    "services_environments_failedToFetchDeploymentId": "Failed to fetch deployment ID",
    "services_enterprise_missingEnvironmentId": "Missing environment ID",
    "services_enterprise_failedToFetchManagedWorkspaces": "Failed to fetch managed workspaces",
    "services_enterprise_missingRequiredParamsToConnectOrg": "Missing required params to connect workspace",
    "services_enterprise_failedToConnectOrg": "Failed to connect workspace",
    "services_enterprise_missingOrgGidToUnconnectWorkspace": "Missing workspace GID to unconnect workspace",
    "services_enterprise_failedToUnconnectOrg": "Failed to unconnect workspace",
    "services_enterprise_failedToConnectApp": "Failed to connect app",
    "services_enterprise_failedToUnconnectApp": "Failed to unconnect app",
    "services_enterprise_failedToFetchDataSources": "Failed to fetch data sources",
    "services_enterprise_failedToDeployDataSource": "Failed to deploy data source",
    "services_enterprise_failedToDisconnectManagedDataSource": "Failed to disconnect managed data source",
    "services_enterprise_environmentIdRequired": "Environment ID is required",
    "services_enterprise_failedToFetchQueries": "Failed to fetch queries",
    "services_enterprise_environmentIdAndQueryGidRequired": "Environment ID and Query GID are required",
    "services_enterprise_failedToDeployQuery": "Failed to deploy query",
    "services_enterprise_queryGidRequired": "Query GID is required",
    "services_enterprise_failedToDisconnectQuery": "Failed to disconnect query",
    "services_apps_failedToFetchApps": "Failed to fetch apps",
    "services_apps_failedToDeployApp": "Failed to deploy app",
    "services_datasources_workspaceIdRequired": "Workspace ID is required",
    "services_datasources_apiKeyRequiredToFetchDataSources": "API key is required to fetch data sources",
    "services_datasources_apiServiceUrlRequiredToFetchDataSources": "API service URL is required to fetch data sources",
    "services_datasources_failedToFetchDataSources": "Failed to fetch data sources",
    "services_datasources_failedToDeployDataSource": "Failed to deploy data source",
    "services_workspace_failedToFetchWorkspaces": "Failed to fetch workspaces",
    "services_workspace_failedToDeployWorkspace": "Failed to deploy workspace",
    "services_managedObjects_missingRequiredParameters": "Missing required parameters",
    "services_managedObjects_failedToCheckManagedStatus": "Failed to check managed status",
    "services_managedObjects_failedToSetAsManaged": "Failed to set {{objType}} as managed",
    "services_managedObjects_failedToRemoveFromManaged": "Failed to remove {{objType}} from managed",
    "services_managedObjects_missingEnvironmentId": "Missing environment ID",
    "services_managedObjects_failedToFetchManagedObjects": "Failed to fetch managed objects",
    "services_managedObjects_failedToFetchManagedObject": "Failed to fetch managed object",
    "services_managedObjects_managedObjectNotFound": "Managed object not found for objGid: {{objGid}}",
    "services_license_apiServiceUrlRequired": "API service URL is required",
    "services_license_licenseInformationUnavailable": "License information unavailable",
    "services_license_licenseCheckTookTooLong": "License check took too long",
    "services_license_licenseServiceNotAvailable": "License service not available",
    "services_license_authenticationRequired": "Authentication required - please check API key",
    "services_license_licenseServiceTemporarilyUnavailable": "License service temporarily unavailable",
    "services_license_remainingAPICalls": "{{remaining}} remaining ({{used}}/{{total}} used, {{percentage}}%)",
  },
  "subscription": {
  ...
  "branding": {
    ...
    "errorPage": "Error Page Text",
    "errorPageHelp": "Enter the text displayed on the error page.",
    "signUpPage": "Sign-Up Page Text",
    "signUpPageHelp": "Enter the text displayed on the sign-up page.",
    "loggedOutPage": "Logged-Out Page Text",
    "loggedOutPageHelp": "Enter the text displayed on the logged-out page.",
    "standardDescription": "Standard Description",
    "standardDescriptionHelp": "Enter the standard description for SEO meta information.",
    "standardTitle": "Standard Title",
    "standardTitleHelp": "Enter the standard title for SEO meta information.",
    "showDocumentation": "Show Documentation",
    "submitIssue": "Allow Submit Issue",
