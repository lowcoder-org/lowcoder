...
export const en = {
  ...
  meeting: {
    ...
    screenSharing: "User Sharing Screen",
    noVideo: "No Video",
  ...
  playground: {
    ...
    preview:
      "Preview (please mind, that your Editor-Layout/Logic Mode is active here too. You can set it to 'Both' in the App Editor to see all properties here too)",
    property: "Properties",
