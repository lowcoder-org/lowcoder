...
export const ru = {
  ...
  "clearDesc": "Очистить свойство: {property}",
  "resetDesc": "Сбросить значение свойства: {свойство} к значению по умолчанию",
  },
  "method": {
    ...en.method,
  ...
  "notSupportError": "Поддерживает только {типы} типов изображений",
  ...
  "expandTip": "Нажмите, чтобы показать данные {компонента}",
  "collapseTip": "Нажмите, чтобы скрыть данные {компонента}",
  "layers": "Слои",
  ...
  "chartDeselectDesc": "Триггеры на графике Снять выделение",
  "close": "Закрыть",
  ...
  "maxValue": "Значение превышает максимум, текущее: {значение}, максимальное: {max}",
  "minValue": "Значение ниже минимального, текущее: {значение}, минимальное: {min}",
  "maxTime": "Время превышает максимум, текущее: {time}, максимальное: {maxTime}",
  "minTime": "Время ниже минимума, текущее: {time}, минимальное: {minTime}",
  "maxDate": "Дата превышает максимум, текущая: {дата}, максимальная: {maxDate}",
  "minDate": "Дата ниже минимума, текущая: {date}, минимальная: {minDate}",
  },
  "query": {
    ...en.query,

  "noQueries": "Запросы данных недоступны.",
  "queryTutorialButton": "Просмотр {значение} документов",
  ...
  "successMessageWithName": "{имя} Выполнить успешно",
  "failMessageWithName": "Выполнение {name} не удалось: {результат}",
  ...
  "address": "Адрес:",
  "nameExists": "Имя {имя} уже существует",
  ...
  "readOnly": "Только чтение",
  "exit": "Выход",
  "recoverAppSnapshotContent": "Восстановление текущего запроса до версии {version}",
  ...
  "bodyFormDataTooltip": "Если выбран {type}, формат значения должен быть {object}. Пример: {example}",
  "text": "Текст",
  "file": "Файл",
  ...
  "required": "Требуется",
  "maximum": "Максимальное значение равно {значение}",
  "minimum": "Минимальное значение - {значение}",
  "exclusiveMaximum": "Должно быть меньше, чем {значение}",
  "exclusiveMinimum": "Должно быть больше, чем {значение}",
  "multipleOf": "Должно быть кратно {значению}",
  "minLength": "По крайней мере {значение} Символы",
  "maxLength": "Максимум {значение} Символы",
  "pattern": "Должно соответствовать шаблону {значение}",
  "format": "Должен соответствовать формату {значение}",
  },
  "select": {
    ...en.select,
  ...
  "pageOffsetDesc": "Текущее начало листания, используется для листания с целью получения данных. Пример: Select * from Users Limit '{{table1.pageSize}}' Смещение '{{table1.pageOffset}}'",
  ...
  "rowColorDesc": "Условная установка цвета строки на основе необязательных переменных: CurrentRow, CurrentOriginalIndex, CurrentIndex, ColumnTitle. Например: '{{ currentRow.id > 3 ? \"зеленый\" : \"красный\" }}'",
  ...
  "cellColorDesc": "Условно установите цвет ячейки на основе значения ячейки с помощью CurrentCell. Например: '{{ currentCell == 3 ? \"зеленый\" : \"красный\" }}'",
  ...
  "timeoutTypeError": "Пожалуйста, введите правильный период тайм-аута в мс, текущий входной сигнал: {значение}",
  "timeoutLessThanMinError": "Input Must Be Greater than {left}, Current Input is: {значение}",
  },
  "selectionControl": {
    ...en.selectionControl,
  ...
  "moveOutOrgDesc": "Вы уверены, что хотите удалить пользователя {имя}? Это действие не может быть восстановлено.",
  ...
  "inviteText": "{userName} приглашает вас присоединиться к рабочему пространству \"{организация}\", нажмите на ссылку для присоединения: {inviteLink}",
  ...
  "unStructuredError": "Неструктурированные данные {prev} не могут быть обновлены по {path}",
  ...
  "excuteMethod": "Выполнить метод {имя}",
  "method": "Метод",
  "action": "Действие",
  "output": "Выход",
  "nameExists": "Имя {имя} уже существует",
  "eventTriggered": "Событие {имя} сработало",
  ...
  "notHandledError": "{метод} Метод не выполнен",
  },
  "aggregation": {
    ...en.aggregation,
  ...
  "bindName": "Связать {имя}",
  "loginAfterBind": "После привязки вы можете использовать {имя} для входа в систему",
  ...
  "recoverAppSnapshotContent": "Восстановление текущего приложения до версии, созданной в {время}.",
  "recoverAppSnapshotMessage": "Восстановить эту версию",
  "returnEdit": "Вернуться к редактору",
  "deploy": "Опубликовать",
  "export": "Экспорт в JSON",
  "editName": "Редактировать имя",
  "duplicate": "Дубликат {типа}",
  "snapshot": "История",
  ...
  "login": "Войти",
  "bind": "Переплет",
  "passwordCheckLength": "Не менее {мин} Персонажи",
  ...
  "inviteWelcomeTitle": "{имя пользователя} приглашает вас к совместной работе",
  "terms": "Условия",
  "privacy": "Политика конфиденциальности",
  "registerHint": "Я прочитал и согласен с",
  "chooseAccount": "Выберите свой аккаунт",
  "signInLabel": "Войти с помощью {имя}",
  "bindAccount": "Привязать аккаунт",
  "scanQrCode": "Отсканируйте QR-код с помощью {имя}",
  ...
  "resetPasswordDesc": "Сброс пароля пользователя {имя}. После сброса будет сгенерирован новый пароль.",
  "resetSuccess": "Сброс прошел успешно",
  "resetSuccessDesc": "Сброс пароля прошел успешно. Новый пароль: {пароль}",
  ...
  "jsLibraryInstallFailedHost": "{сообщение}",
  "add": "Добавить новый",
  ...
  "layout": "'{0}' Настройка макета",
  "upgrade": "Обновление '{0}'",
  "delete": "Удалить '{0}'",
  "add": "Добавить '{0}'",
  "modify": "Изменить '{0}'",
  "rename": "Переименуйте '{1}' в '{0}'",
  "recover": "Восстановите версию '{2}'",
  ...
  "moveToFolderSubTitle": "Переместите \"{имя}\" в:",
  "folderName": "Имя папки:",
  "resCardSubTitle": "{время} от {создателя}",
  ...
  "moveToTrashSubTitle": "{тип} {имя} будет перемещен в корзину.",
  "deleteElementSubTitle": "Удалить {тип} Удалите {имя} навсегда, его нельзя будет восстановить.",
  ...
  "newNavLayout": "{имя пользователя}",
  "newApp": "{Новое {имя пользователя}",
  "importError": "Ошибка импорта, {message}",
  "exportError": "Ошибка экспорта, {сообщение}",
  ...
  "copyModalTitle": "Клон \"{имя}\"",
  "copyNameLabel": "{тип} имя",
  "copyModalfolderLabel": "Добавить в папку",
  "copyNamePlaceholder": "Пожалуйста, введите имя {типа}",
  ...
  "example": "Примеры",
  "defaultMethodDesc": "Установить значение свойства {name}",
  ...
  "save": "Сохранить",
  "none": "Нет",
  "formPlaceholder": "Пожалуйста, введите {метку}",
  "formSelectPlaceholder": "Пожалуйста, выберите {ярлык}",
  "saveSuccess": "Сохранено успешно",
  ...
  "manualTip": "",
  "lockTip": "Содержимое заблокировано. Чтобы внести изменения, нажмите на {значок}, чтобы разблокировать.",
