...
export const it = {
  ...
  "productDesc": "Create applicazioni software per la vostra azienda e i vostri clienti con un'esperienza minima di codifica.",
  ...
  "news": "Notizie",
  "newsLoading": "caricamento...",
  "developerNetwork": "Rete di sviluppatori",
