...
export const it = {
  ...
  "showEmptyValidation": "Mostra convalida su vuoto/ripristino",
  ...
  "escapeClose": "Abilita la chiusura con il tasto Escape",
  ...
  "mainScrollbar": "Mostra le barre di scorrimento nel contenuto principale",
  "modalScrollbar": "Mostra le barre di scorrimento nella finestra modale",
  "drawerScrollbar": "Mostra le barre di scorrimento nel cassetto",
  "textAreaScrollBar": "Mostra le barre di scorrimento nell'area di testo",
  ...
  "queryVariables": "Variabili della query",
  ...
  "sortChangeDesc": "Trigger sulle modifiche all'ordinamento",
  },
  "style": {
    ...en.style,
  ...
  "gradientBackground": "Colore di sfondo gradiente",
  "direction": "Direzione",
  "chartOpacity": "Opacità",
  "chartBoxShadow": "Box Shadow",
  "chartBorderStyle": "Stile del bordo",
  "chartBorderRadius": "Raggio del bordo",
  "chartBorderWidth": "Larghezza del bordo",
  "chartTextSize": "Dimensione del testo",
  "chartTextWeight": "Peso del testo",
  "chartFontFamily": "Famiglia di caratteri",
  "chartFontStyle": "Stile del carattere",
  "chartBackgroundColor": "Colore di sfondo",
  "chartGradientColor": "Colore sfumato",
  "chartShadowColor": "Colore dell'ombra",
  "chartBorderColor": "Colore del bordo",
  "chartTextColor": "Colore del testo",
  "detailSize": "Dettaglio Dimensioni",
  ...
  "quickAlasql": "Query SQL locale",
  "databaseType": "Tipo di database",
  "chooseDatabase": "Scegliere il database",
  "lowcoderAPI": "API Lowcoder",
  "executeJSCode": "Eseguire il codice JavaScript",
  "importFromQueryLibrary": "Importazione da Query Library",
  "preparedDataQueries": "Le query di dati preparate",
  "adHocDataQueries": "Query di dati Qick (senza query o origine dati preparate)",
  "queryResultTransformer": "Manipolare una risposta alla query per trasformare i dati prima del binding",
  "queryResultReactor": "Reagire a qualsiasi modifica di un valore dinamico dei dati",
  ...
  "legacy": "Preesistenti e deprecati",
  },
  "uiComp": {
    ...en.uiComp,
  ...
  "splitLayoutCompName": "Layout diviso",
  "splitLayoutCompDesc": "Un componente di layout per organizzare aree di visualizzazione multiple e aree separate orizzontalmente o verticalmente. Offre all'utente la possibilità di adattare la larghezza o l'altezza delle aree di visualizzazione mediante trascinamento.",
  "splitLayoutCompKeywords": "dividere, dividere, layout, adattare, dimensione dello schermo",
  "iconCompName": "Icone",
  ...
  "kanbanCompName": "Lavagna Kanban (anteprima!)",
  ...
  "kanbanCompKeywords": "kanban, scheda, flusso di lavoro, attività",
  "pieChartCompName": "Grafico a torta",
  "pieChartCompDesc": "Un componente versatile per la visualizzazione dei dati con i grafici a torta.",
  "pieChartCompKeywords": "grafico, dati, visualizzazione",
  "lineChartCompName": "Grafico a linee",
  "lineChartCompDesc": "Un componente versatile per la visualizzazione dei dati con i grafici a linee.",
  "lineChartCompKeywords": "grafico, dati, visualizzazione",
  "barChartCompName": "Grafico a barre",
  "barChartCompDesc": "Un componente versatile per la visualizzazione dei dati con grafici a barre.",
  "barChartCompKeywords": "grafico, dati, visualizzazione",
  "scatterChartCompName": "Grafico a dispersione",
  "scatterChartCompDesc": "Un componente versatile per la visualizzazione dei dati con i grafici di dispersione.",
  "scatterChartCompKeywords": "grafico, dati, visualizzazione",
  ...
  "forceCapture": "Forza di cattura",
  "forceCaptureTooltip": "Invece di caricare, catturare l'immagine dalla fotocamera",
  "usePhoto": "Usa foto",
  ...
  "clipPath": "Percorso di ritaglio dell'immagine",
  "clipPathTip": "Utilizzare clip-path per definire una forma personalizzata per l'elemento in base a una definizione CSS, facendo riferimento a una maschera SVG (tramite l'URL di origine) o utilizzando forme predefinite come cerchio(), ellisse(), poligono() o inset() per il ritaglio.",
  "enableOverflow": "Abilita l'overflow",
  "enableOverflowTip": "Permette all'immagine di traboccare dal suo contenitore, consentendo il ritaglio oltre i limiti del contenitore. Utile per mantenere l'attenzione su parti specifiche dell'immagine.",
  "overflow": "Comportamento del trabocco (CSS)",
  "overflowTip": "Definisce il comportamento del contenuto quando trabocca dal contenitore. Opzioni come 'hidden', 'scroll' o 'visible' determinano la visibilità del contenuto ritagliato.",
  "positionX": "Posizione orizzontale",
  "positionXTip": "Specifica l'allineamento orizzontale dell'immagine all'interno del suo contenitore. Esempi: 'sinistra', 'centro', 'destra' o valori percentuali.",
  "positionY": "Posizione verticale",
  "positionYTip": "Specifica l'allineamento verticale dell'immagine all'interno del suo contenitore. Esempi: 'superiore', 'centrale', 'inferiore' o valori percentuali.",
  "aspectRatio": "Rapporto di aspetto (CSS)",
  "aspectRatioTip": "Mantiene un rapporto larghezza/altezza coerente per l'immagine, come ad esempio '16/9' per il widescreen o '1/1' per il quadrato. Lasciare vuoto per le dimensioni naturali dell'immagine.",
  "placement": "Posizionamento dell'immagine",
  "placementTip": "Determina dove e come l'immagine viene visualizzata all'interno del layout o del contenitore. Le opzioni includono una logica specifica di allineamento o posizionamento.",
  },
  "progress": {
    ...en.progress,
  ...
  "searchIcon": "Cercare un'icona",
  "searchAnimation": "Ricerca di un'animazione",
  "searchIllustration": "Ricerca di un'illustrazione",
  ...
  "AuditLogTitle": "Registro di controllo Dasboard",
  "AuditLogOverview": "Filtro di registro",
  "USER_LOGIN": "Accesso utente",
  "USER_LOGOUT": "Disconnessione dell'utente",
  "APPLICATION_VIEW": "Visualizza applicazione",
  "APPLICATION_CREATE": "Crea applicazione",
  "APPLICATION_DELETE": "Cancellare l'applicazione",
  "APPLICATION_UPDATE": "Aggiornamento dell'applicazione",
  "APPLICATION_MOVE": "Spostare la domanda",
  "APPLICATION_RECYCLED": "Applicazione di riciclo",
  "APPLICATION_RESTORE": "Ripristino dell'applicazione",
  "APPLICATION_PUBLISH": "Pubblicazione di applicazioni",
  "APPLICATION_VERSION_CHANGE": "Aggiornamento della versione dell'applicazione",
  "APPLICATION_SHARING_CHANGE": "Modifica della condivisione delle applicazioni",
  "APPLICATION_PERMISSION_CHANGE": "Modifica del permesso di applicazione",
  "FOLDER_CREATE": "Crea cartella",
  "FOLDER_DELETE": "Elimina cartella",
  "FOLDER_UPDATE": "Cartella di aggiornamento",
  "QUERY_EXECUTION": "Eseguire la query",
  "GROUP_CREATE": "Crea gruppo",
  "GROUP_UPDATE": "Gruppo di aggiornamento",
  "GROUP_DELETE": "Cancellare il gruppo",
  "GROUP_MEMBER_ADD": "Aggiungi un membro del gruppo",
  "GROUP_MEMBER_ROLE_UPDATE": "Aggiornare il ruolo di membro del gruppo",
  "GROUP_MEMBER_LEAVE": "Gruppo di congedo",
  "GROUP_MEMBER_REMOVE": "Rimuovere un membro del gruppo",
  "SERVER_START_UP": "Avvio del server",
  "SERVER_INFO": "Visualizza informazioni sul server",
  "DATA_SOURCE_CREATE": "Creare una fonte di dati",
  "DATA_SOURCE_UPDATE": "Aggiornare la fonte di dati",
  "DATA_SOURCE_DELETE": "Eliminare la fonte di dati",
  "DATA_SOURCE_PERMISSION_GRANT": "Concessione dell'autorizzazione alla fonte di dati",
  "DATA_SOURCE_PERMISSION_UPDATE": "Aggiornare l'autorizzazione della fonte di dati",
  "DATA_SOURCE_PERMISSION_DELETE": "Autorizzazione di cancellazione della sorgente dati",
  "LIBRARY_QUERY_CREATE": "Creare una query di biblioteca",
  "LIBRARY_QUERY_UPDATE": "Aggiornare la query della biblioteca",
  "LIBRARY_QUERY_DELETE": "Eliminare la query della biblioteca",
  "LIBRARY_QUERY_PUBLISH": "Pubblicare la query della biblioteca",
  "API_CALL_EVENT": "Evento di chiamata API",
  "logFilter": "Filtro di registro",
  "noLogsFound": "Non sono stati trovati registri. Regolare i filtri e riprovare.",
  "usageLogUserEngagement": "Coinvolgimento degli utenti per regione",
  "usageLogAppViews": "Utilizzo dell'app nel tempo",
  "usageLogTopTen": "Top 10 delle applicazioni",
  "usageLogAnonymousKNown": "Utenti anonimi/conosciuti",
  ...
  "AuditLogsIntroTitle": "Potente visibilità sull'attività del vostro spazio di lavoro",
  "AuditLogsIntro1": "I registri di audit consentono agli amministratori di tracciare esattamente ciò che accade nell'intera piattaforma Lowcoder. Dall'accesso degli utenti alle modifiche delle app, ogni azione rilevante viene catturata e memorizzata.",
  "AuditLogsIntro2": "Per ogni evento includiamo metadati dettagliati come la geolocalizzazione, il tipo di dispositivo, il browser e il sistema operativo.",
  "AuditLogsIntro3": "Questa trasparenza consente di monitorare l'attività in tutti gli ambienti connessi, fornendo una solida traccia di audit per supportare la conformità, la sicurezza e la comprensione operativa.",
  "AuditLogsEventsTitle": "Quali eventi vengono monitorati?",
  "AuditLogsEventsIntro": "Le seguenti azioni dell'utente vengono registrate in tempo reale:",
  "SignIn": "Accedi",
  "Logout": "Disconnessione",
  "ViewApp": "Visualizza l'applicazione",
  "CreateApp": "Creare una nuova applicazione",
  "DeleteApp": "Eliminare l'applicazione",
  "UpdateApp": "Aggiornamento app",
  "MoveToFolder": "Sposta nella cartella",
  "MoveToTrash": "Sposta nel cestino",
  "RestoreApp": "Restore app",
  "CreateFolder": "Creare una nuova cartella",
  "DeleteFolder": "Cancellare la cartella",
  "UpdateFolder": "Cartella di aggiornamento",
  "ExecuteDataQuery": "Execute data query",
  "CreateUserGroup": "Creare un nuovo gruppo di utenti",
  "UpdateUserGroup": "Aggiornare il gruppo di utenti",
  "DeleteUserGroup": "Cancellare il gruppo di utenti",
  "AddGroupMember": "Aggiungere un membro del gruppo di utenti",
  "UpdateGroupMemberRole": "Aggiornare il ruolo di un membro del gruppo di utenti",
  "LeaveUserGroup": "Lasciare il gruppo utente",
  "RemoveGroupMember": "Rimuovere il membro di un gruppo di utenti",
  "ServerStartup": "Avvio del server",
  "CreateDataSource": "Creare l'origine dati",
  "UpdateDataSource": "Aggiornare l'origine dati",
  "DeleteDataSource": "Delete data source",
  "GrantUpdateDeletePermission": "Concedere o aggiornare le autorizzazioni",
  "LibraryQueryActions": "Creare / aggiornare / cancellare le query della biblioteca",
  "PublishLibraryQuery": "Pubblicare la query della biblioteca",
  "AuditLogsPreviewTitle": "Anteprima del Registro di controllo in azione (fare clic per ingrandire)",
  "ScreenshotPlaceholder1": "[ Screenshot 1 Placeholder ]",
  "ScreenshotPlaceholder2": "[ Screenshot 2 Placeholder ]",
  "ScreenshotPlaceholder3": "[ Segnaposto screenshot 3 ]",
  "PricingTitle": "Prezzi dell'edizione Enterprise",
  "PricingIntro": "Offriamo prezzi flessibili per organizzazioni di qualsiasi dimensione, adattati al vostro modello di utilizzo:",
  "FlatRateTitle": "Opzione 1: tariffa forfettaria per istanza - $169 / mese",
  "FlatRateDesc": "Un'istanza è un ambiente Lowcoder completo (database dei metadati + runtime) che può essere distribuito in modo indipendente. Questo include:",
  "FlatRatePoint1": "Un archivio di metadati MongoDB dedicato",
  "FlatRatePoint2": "Una o più app runtime (contenitori \"Api-Service\" e/o \"Node-Service\")",
  "UsagePricingTitle": "Opzione 2: Prezzo basato sull'uso - $0,001 per chiamata API",
  "UsagePricingDesc": "In alternativa, ogni istanza può essere concessa in licenza in base all'utilizzo delle API. Offriamo pacchetti prepagati:",
  "API100k": "100.000 chiamate API - $100",
  "API1M": "1.000.000 di chiamate API - $1.000",
  "API10M": "10.000.000 di chiamate API - $10.000",
  "UsageOverrunDesc": "Quando il vostro pacchetto API si esaurisce, vi avvisiamo. Una volta consumato il pacchetto, l'istanza rimane funzionante ma funzionerà a velocità ridotta per evitare abusi e mantenere la correttezza.",
  "UsageTopUpInfo": "È possibile aggiungere pacchetti aggiuntivi in qualsiasi momento per garantire un accesso continuo e veloce, senza interruzioni del servizio.",
  "AppUsageTitle": "Registri di utilizzo delle app",
  "AppUsageIntroTitle": "Capire come vengono utilizzate le vostre app",
  "AppUsageIntro1": "I registri di utilizzo delle app forniscono informazioni approfondite sul consumo delle applicazioni Lowcoder pubblicate.",
  "AppUsageIntro2": "Questa funzionalità funziona come una versione integrata e semplificata di Google Analytics, ma completamente privata e limitata alla vostra istanza Lowcoder.",
  "AppUsageIntro3": "Gli amministratori possono analizzare l'accesso alle app nel tempo, quali sono le più utilizzate e da dove gli utenti si connettono.",
  "AppUsageMetricsTitle": "Metriche da tenere sotto controllo...",
  "AppUsageMetricsIntro": "Queste analisi aiutano a prendere decisioni informate sul coinvolgimento e sull'utilizzo della piattaforma:",
  "MetricActiveUsers": "Visualizzazioni dell'app per giorno / settimana / mese (in base al filtro temporale)",
  "MetricViewsPerApp": "Top 10 delle applicazioni",
  "MetricDevices": "Accesso per dispositivo (desktop, tablet, mobile)",
  "MetricBrowsers": "Accesso per browser e sistema operativo",
  "MetricCountries": "Origine geografica degli utenti",
  "AppUsageScreenshotsTitle": "App Usage Analytics in azione (clicca per ingrandire)",
  "AppUsageScreenshot1": "[ Schermata del cruscotto di utilizzo delle app ]",
  "AppUsageScreenshot2": "[ Grafico delle visualizzazioni per app ]",
  "AppUsageScreenshot3": "[ Mappa di distribuzione geografica ]",
  "BrandingIntroTitle": "Marchio personalizzato e White-Labeling",
  "BrandingIntro1": "Con le impostazioni di branding di Lowcoders, potete elevare l'esperienza del prodotto per i vostri utenti offrendo un branding completamente personalizzabile.",
  "BrandingIntro2": "Date ai vostri clienti o ai team interni la possibilità di utilizzare la piattaforma come se fosse la loro: logo, colori, font e pagine personalizzate sono inclusi.",
  "BrandingIntro3": "Oppure avete bisogno di una soluzione completamente white-label e di rafforzare l'identità del vostro marchio in ogni punto di contatto.",
  "BrandingColorsIntro1": "È possibile impostare la propria combinazione di colori in base all'identità aziendale, compresi gli elementi primari dell'interfaccia utente e le barre di navigazione.",
  "BrandingColorsIntro2": "Personalizzate le evidenziazioni della barra laterale, le sezioni dell'intestazione e persino il contrasto del testo per migliorare l'esperienza dell'utente e l'accessibilità.",
  "BrandingFontsIntro": "Scegliete tra i font curati di Google per rendere la vostra applicazione veramente vostra sia in termini di stile che di leggibilità.",
  "BrandingLogosIntro": "Naturalmente, è possibile caricare i propri loghi, rettangolari e quadrati, da inserire nelle intestazioni, nelle dashboard e nelle schermate di login. Mantenete la coerenza del marchio su tutti i dispositivi e gli schermi.",
  "BrandingPagesIntro1": "Aggiungete testo e immagini personalizzate alle pagine di errore, ai flussi di iscrizione e ai messaggi di logout.",
  "BrandingPagesIntro2": "Questi punti di contatto contribuiscono a fornire un'esperienza completamente brandizzata anche in caso di scenari imprevisti o di transizioni di account.",
  "BrandingMetaIntro": "Definire metadati standard come titolo e descrizione della pagina per migliorare la presenza SEO e la comunicazione del marchio.",
  "BrandingHelpLinksIntro": "Aggiungete collegamenti alla documentazione sensibili al contesto direttamente all'interno dell'applicazione, fornendo un aiuto just-in-time ai vostri utenti.",
  "BrandingWhatsNewIntro": "Attivate la sezione \"Cosa c'è di nuovo\" per evidenziare gli aggiornamenti e gli annunci di prodotto in modo visibile e di marca.",
  "EnvironmentsIntroTitle": "Stabilizzazione Lowcoder",
  "EnvironmentsTitle": "Infrastruttura multi-ambiente",
  "EnvironmentsIntro1": "Gli ambienti Lowcoder consentono di separare le fasi di sviluppo, test e produzione in modo pulito e sicuro.",
  "EnvironmentsIntro2": "I team aziendali beneficiano di flussi di lavoro di rilascio strutturati, processi di approvazione e stabilità delle versioni in tutte le fasi.",
  "EnvironmentsIntro3": "Con la funzione Ambienti, gli amministratori possono controllare cosa viene distribuito, quando e dove, il tutto da un'unica interfaccia.",
  ...
  "yourDeploymentID": "Il vostro ID di schieramento",
  "EnvironmentsFeaturePreviewTitle": "Ambienti e distribuzione in azione (fare clic per ingrandire)",
  "EnvironmentsUseCasesTitle": "Perché usare gli ambienti? (Messa in scena)",
  "EnvironmentsUseCase1": "Prevenite le modifiche involontarie in produzione testando le applicazioni in ambienti Dev o QA dedicati.",
  "EnvironmentsUseCase2": "Allineatevi alla governance IT aziendale implementando distribuzioni graduali con tracciamento pronto per l'audit.",
  "EnvironmentsUseCase3": "Consentite ai team di costruire con fiducia con configurazioni, dati e integrazioni specifiche dell'ambiente.",
  "EnvironmentsFeaturesTitle": "Cosa si ottiene",
  "EnvironmentsFeature1": "Cruscotto centralizzato per visualizzare e gestire tutti gli ambienti Lowcoder.",
  "EnvironmentsFeature2": "Distribuzione di applicazioni, fonti di dati e configurazioni tra ambienti, direttamente dall'interfaccia utente, senza la necessità di strumenti CI/CD aggiuntivi.",
  "EnvironmentsFeature3": "Controlli di accesso e regole di visibilità specifici per l'ambiente.",
  "EnvironmentsFeature5": "Chiara separazione delle attività di staging, sandbox e produzione.",
  "apiUsage": "Chiamate API.",
  "loadingApiUsage": "Caricamento dei dati di utilizzo dell'API...",
  },
  "environments": {
    ...en.environments,
  ...
  "errorLoadingEnvironments": "Errore nel caricamento degli ambienti",
  "noEnvironmentsFoundMatching": "Nessun ambiente trovato corrispondente a \"{searchText}\".",
  "noEnvironmentsFound": "Nessun ambiente trovato. Creare il primo ambiente per iniziare.",
  "environmentsTypeLabel": "{type} Ambienti",
  "showingAllEnvironments": "Mostra tutti gli ambienti {count}",
  "unnamedEnvironment": "Ambiente senza nome",
  "masterEnvironment": "Ambiente Master",
  "viewAuditLogs": "Visualizzazione dei registri di audit",
  "id": "ID",
  "domain": "Dominio",
  "master": "Maestro",
  "license": "Licenza",
  ...
  "licenseStatus_checking": "Controllo...",
  "licenseStatus_licensed": "Licenza",
  "licenseStatus_unlicensed": "Licenza richiesta",
  "licenseStatus_error": "Configurazione richiesta",
  "licenseStatus_unknown": "Sconosciuto",
  "detail_environmentNotFound": "Ambiente non trovato",
  "detail_returnToEnvironmentsList": "Ritorno all'elenco degli ambienti",
  "detail_environmentDetail": "Dettaglio ambiente",
  "detail_environmentOverview": "Panoramica dell'ambiente",
  "detail_noDomainSet": "Nessun dominio impostato",
  "detail_environmentId": "ID ambiente",
  "detail_licenseStatus": "Stato della licenza",
  "detail_licenseNeeded": "Licenza necessaria",
  "detail_setupRequired": "Configurazione richiesta",
  "detail_created": "Creato",
  "detail_unknown": "Sconosciuto",
  "detail_licenseDetails": "Dettagli della licenza",
  "detail_apiCallsRemaining": "Chiamate API rimanenti",
  "detail_totalApiCallsLimit": "Limite totale di chiamate API",
  "detail_enterpriseEdition": "Edizione Enterprise",
  "detail_active": "Attivo",
  "detail_inactive": "Inattivo",
  "detail_licenseInformation": "Informazioni sulla licenza",
  "detail_calls": "chiamate",
  "detail_licenses": "Licenze",
  "detail_license": "Licenza",
  "detail_workspaces": "Spazi di lavoro",
  "detail_userGroups": "Gruppi di utenti",
  "detail_type": "Tipo",
  "detail_status": "Stato",
  "detail_licensed": "Licenza",
  "detail_unlicensed": "Senza licenza",
  "detail_apiKey": "Chiave API",
  "detail_configured": "Configurato",
  "detail_notSet": "Non impostato",
  "detail_masterEnv": "Master Env",
  "unlicensed_unlicensedDescription": "Questo ambiente necessita di una licenza valida per sbloccare tutte le sue capacità e caratteristiche. Assicurarsi che l'URL del servizio API sia configurato correttamente e che il plugin sia installato.",
  "unlicensed_errorDescription": "Si è verificato un problema durante la verifica della licenza. Rivedere le impostazioni di configurazione.",
  "unlicensed_defaultDescription": "Questo ambiente richiede la configurazione della licenza per procedere.",
  "unlicensed_contactLowcoderTeam": "Contatta il team Lowcoder",
  "unlicensed_editEnvironment": "Modifica dell'ambiente",
  "unlicensed_backToEnvironments": "Torna a Ambienti",
  "unlicensed_helpText": "Avete bisogno di assistenza? Contattate il nostro team per ricevere assistenza sulle licenze o modificate la configurazione dell'ambiente per risolvere il problema.",
  "unlicensed_type": "Tipo",
  "unlicensed_status": "Stato",
  "unlicensed_masterEnv": "Master Env",
  "unlicensed_licenseIssue": "Problema di licenza",
  "unlicensed_error": "Errore",
  "unlicensed_missing": "Mancante",
  "error_itemNotFound": "L'articolo che state cercando non esiste o non avete i permessi per visualizzarlo.",
  "modal_createNewEnvironment": "Creare un nuovo ambiente",
  "modal_editEnvironment": "Modifica dell'ambiente",
  "modal_cancel": "Annullamento",
  "modal_createEnvironment": "Creare un ambiente",
  "modal_saveChanges": "Salva le modifiche",
  "modal_environmentName": "Nome dell'ambiente",
  "modal_pleaseEnterName": "Inserire un nome",
  "modal_nameMinLength": "Il nome deve essere composto da almeno 2 caratteri",
  "modal_enterEnvironmentName": "Inserire il nome dell'ambiente",
  "modal_description": "Descrizione",
  "modal_enterDescription": "Inserire la descrizione",
  "modal_stage": "Palcoscenico",
  "modal_pleaseSelectStage": "Selezionare una fase",
  "modal_selectStage": "Selezionare la fase",
  "modal_development": "Sviluppo (DEV)",
  "modal_testing": "Test (TEST)",
  "modal_preProduction": "Pre-produzione (PREPROD)",
  "modal_production": "Produzione (PROD)",
  "modal_frontendUrl": "URL del frontend",
  "modal_pleaseEnterValidUrl": "Inserire un URL valido",
  "modal_apiServiceUrl": "URL del servizio API",
  "modal_nodeServiceUrl": "URL del servizio del nodo",
  "modal_apiKey": "Chiave API",
  "modal_enterApiKey": "Inserire la chiave API",
  "modal_masterEnvironment": "Ambiente Master",
  "modal_alreadyMasterEnvironment": "{name} è già l'ambiente Master",
  "modal_willBeMaster": "Sarà Maestro",
  "modal_currentlyMaster": "Attualmente Master",
  "modal_configurationRequirements": "Requisiti di configurazione",
  "modal_configurationRequirementsDesc": "Assicurarsi che l'URL del servizio API sia configurato e corretto, che la chiave API sia valida e, per la verifica della licenza, assicurarsi che la licenza e il plugin siano installati correttamente.",
  "workspaces_title": "Spazi di lavoro",
  "workspaces_subtitle": "Gestire gli spazi di lavoro in questo ambiente",
  "workspaces_refresh": "Aggiornare",
  "workspaces_errorLoadingWorkspaces": "Errore nel caricamento degli spazi di lavoro",
  "workspaces_configurationIssue": "Problema di configurazione",
  "workspaces_missingConfiguration": "Manca la configurazione richiesta: Chiave API o URL del servizio API",
  "workspaces_totalWorkspaces": "Totale spazi di lavoro",
  "workspaces_managedWorkspaces": "Spazi di lavoro gestiti",
  "workspaces_unmanagedWorkspaces": "Spazi di lavoro non gestiti",
  "workspaces_workspace": "Spazio di lavoro",
  "workspaces_role": "Ruolo",
  "workspaces_status": "Stato",
  "workspaces_managed": "Gestito",
  "workspaces_unmanaged": "Non gestito",
  "workspaces_actions": "Azioni",
  "workspaces_viewAuditLogs": "Visualizzazione dei registri di audit",
  "workspaces_audit": "Audit",
  "workspaces_searchWorkspaces": "Ricerca degli spazi di lavoro per nome o ID",
  "workspaces_showAll": "Mostra tutto",
  "workspaces_managedOnly": "Solo gestito",
  "workspaces_showingResults": "Mostra {count} di {total} spazi di lavoro",
  "workspaces_paginationTotal": "{start}-{end} di {total} spazi di lavoro",
  "workspaces_noWorkspacesFound": "Non sono stati trovati spazi di lavoro in questo ambiente",
  "userGroups_title": "Gruppi di utenti",
  "userGroups_subtitle": "Gestire i gruppi di utenti in questo ambiente",
  "userGroups_refresh": "Aggiornare",
  "userGroups_errorLoadingUserGroups": "Errore nel caricamento dei gruppi di utenti",
  "userGroups_configurationIssue": "Problema di configurazione",
  "userGroups_missingConfiguration": "Manca la configurazione richiesta: Chiave API o URL del servizio API",
  "userGroups_totalGroups": "Totale gruppi",
  "userGroups_allUsersGroups": "Tutti i gruppi di utenti",
  "userGroups_developerGroups": "Gruppi di sviluppatori",
  "userGroups_customGroups": "Gruppi personalizzati",
  "userGroups_userGroup": "Gruppo di utenti",
  "userGroups_type": "Tipo",
  "userGroups_allUsers": "Tutti gli utenti",
  "userGroups_developers": "Sviluppatori",
  "userGroups_custom": "Personalizzato",
  "userGroups_members": "Membri",
  "userGroups_adminMembers": "Membri dell'amministrazione",
  "userGroups_created": "Creato",
  "userGroups_totalMembersTooltip": "Numero totale di membri del gruppo",
  "userGroups_adminMembersTooltip": "Numero di utenti amministratori in questo gruppo",
  "userGroups_searchUserGroups": "Ricerca di gruppi di utenti per nome o ID",
  "userGroups_showingResults": "Mostra {count} di {total} gruppi di utenti",
  "userGroups_paginationTotal": "{start}-{end} di {total} gruppi di utenti",
  "userGroups_noUserGroupsFound": "Nessun gruppo di utenti trovato in questo ambiente",
  "apps_title": "Applicazioni",
  "apps_subtitle": "Gestire le applicazioni dello spazio di lavoro",
  "apps_refresh": "Aggiornare",
  "apps_errorLoadingApps": "Errore nel caricamento delle applicazioni",
  "apps_configurationIssue": "Problema di configurazione",
  "apps_missingConfiguration": "Manca la configurazione richiesta: Chiave API o URL del servizio API",
  "apps_totalApps": "Totale applicazioni",
  "apps_publishedApps": "Applicazioni pubblicate",
  "apps_managedApps": "Applicazioni gestite",
  "apps_unmanagedApps": "Applicazioni non gestite",
  "apps_app": "App",
  "apps_status": "Stato",
  "apps_published": "Pubblicato",
  "apps_draft": "Bozza",
  "apps_managed": "Gestito",
  "apps_unmanaged": "Non gestito",
  "apps_deploy": "Distribuire",
  "apps_audit": "Audit",
  "apps_appMustBeManagedToDeploy": "L'applicazione deve essere gestita prima di essere distribuita",
  "apps_deployThisApp": "Distribuire l'applicazione in un altro ambiente",
  "apps_viewAuditLogs": "Visualizzazione dei registri di audit",
  "apps_searchApps": "Cercare le app per nome o ID",
  "apps_showAll": "Mostra tutto",
  "apps_managedOnly": "Solo gestito",
  "apps_showingResults": "Mostra {count} di {total} applicazioni",
  "apps_paginationTotal": "{start}-{end} di {total} apps",
  "apps_noAppsFound": "Nessuna applicazione trovata in questo spazio di lavoro",
  "apps_appRecycled": "Questa applicazione è stata spostata nel cestino",
  "apps_managedSuccess": "{name} è ora Gestito",
  "apps_unmanagedSuccess": "{name} è ora Non gestito",
  "apps_managedError": "Impossibile modificare lo stato gestito per {name}.",
  "dataSources_title": "Fonti dei dati",
  "dataSources_subtitle": "Gestire le connessioni ai dati dell'area di lavoro",
  "dataSources_refresh": "Aggiornare",
  "dataSources_errorLoadingDataSources": "Errore nel caricamento delle fonti di dati",
  "dataSources_configurationIssue": "Problema di configurazione",
  "dataSources_missingConfiguration": "Manca la configurazione richiesta: Chiave API o URL del servizio API",
  "dataSources_totalDataSources": "Totale fonti di dati",
  "dataSources_availableTypes": "Tipi disponibili",
  "dataSources_managed": "Gestito",
  "dataSources_unmanaged": "Non gestito",
  "dataSources_dataSource": "Fonte dei dati",
  "dataSources_type": "Tipo",
  "dataSources_status": "Stato",
  "dataSources_deploy": "Distribuire",
  "dataSources_audit": "Audit",
  "dataSources_dataSourceMustBeManagedToDeploy": "L'origine dati deve essere gestita prima di essere distribuita",
  "dataSources_deployThisDataSource": "Distribuire questa origine dati in un altro ambiente",
  "dataSources_viewAuditLogs": "Visualizzazione dei registri di audit",
  "dataSources_searchDataSources": "Ricerca delle fonti di dati per nome o ID",
  "dataSources_showAll": "Mostra tutto",
  "dataSources_managedOnly": "Solo gestito",
  "dataSources_showingResults": "Mostra {count} di {total} fonti di dati",
  "dataSources_paginationTotal": "{start}-{end} di {total} fonti di dati",
  "dataSources_noDataSourcesFound": "Nessuna fonte di dati trovata in questo spazio di lavoro",
  "dataSources_managedSuccess": "{name} è ora Gestito",
  "dataSources_unmanagedSuccess": "{name} è ora Non gestito",
  "dataSources_managedError": "Impossibile modificare lo stato gestito per {name}.",
  "queries_title": "Domande",
  "queries_subtitle": "Gestire le query API dell'area di lavoro",
  "queries_refresh": "Aggiornare",
  "queries_errorLoadingQueries": "Errore nel caricamento delle query",
  "queries_configurationIssue": "Problema di configurazione",
  "queries_missingConfiguration": "Manca la configurazione richiesta: Chiave API o URL del servizio API",
  "queries_totalQueries": "Totale interrogazioni",
  "queries_managed": "Gestito",
  "queries_unmanaged": "Non gestito",
  "queries_query": "Interrogazione",
  "queries_creator": "Creatore",
  "queries_status": "Stato",
  "queries_deploy": "Distribuire",
  "queries_audit": "Audit",
  "queries_queryMustBeManagedToDeploy": "La query deve essere gestita prima di essere distribuita",
  "queries_deployThisQuery": "Distribuire questa query in un altro ambiente",
  "queries_viewAuditLogs": "Visualizzazione dei registri di audit",
  "queries_searchQueries": "Ricerca per nome o ID",
  "queries_showAll": "Mostra tutto",
  "queries_managedOnly": "Solo gestito",
  "queries_showingResults": "Mostrando {count} di {total} query",
  "queries_paginationTotal": "{start}-{end} di {total} interrogazioni",
  "queries_noQueriesFound": "Nessuna query trovata in questo spazio di lavoro",
  "queries_managedSuccess": "{name} è ora Gestito",
  "queries_unmanagedSuccess": "{name} è ora Non gestito",
  "queries_managedError": "Impossibile modificare lo stato gestito per {name}.",
  "deployModal_deployTitle": "Distribuire {singularLabel}: {name}",
  "deployModal_loadingEnvironments": "Caricamento degli ambienti...",
  "deployModal_sourceEnvironment": "Fonte Ambiente",
  "deployModal_targetEnvironment": "Ambiente target",
  "deployModal_selectTargetEnvironment": "Selezionare l'ambiente di destinazione",
  "deployModal_selectTargetEnvironmentValidation": "Selezionare un ambiente di destinazione",
  "deployModal_confirmed": "Confermato",
  "deployModal_cancel": "Annullamento",
  "deployModal_deploy": "Distribuire",
  "deployModal_targetEnvironmentNotFound": "Ambiente di destinazione non trovato",
  "deployModal_confirmCredentialOverwrite": "Confermare la sovrascrittura delle credenziali prima di eseguire la distribuzione",
  "deployModal_deploySuccess": "Distribuito con successo {name} nell'ambiente di destinazione",
  "deployModal_deployFailed": "Impossibile distribuire {singularLabel}",
  "deployModal_selectFieldValidation": "Si prega di selezionare {label}",
  "deployModal_selectFieldPlaceholder": "Selezionare {label}",
  "deployModal_inputFieldValidation": "Si prega di inserire {label}",
  "deployModal_inputFieldPlaceholder": "Inserire {label}",
  "contactLowcoder_title": "Contatta il team Lowcoder",
  "contactLowcoder_environmentLabel": "Ambiente:",
  "contactLowcoder_environmentIdLabel": "ID ambiente:",
  "contactLowcoder_deploymentIdLabel": "ID di schieramento:",
  "contactLowcoder_loading": "Caricamento...",
  "contactLowcoder_notAvailable": "Non disponibile",
  "contactLowcoder_unnamedEnvironment": "Ambiente senza nome",
  "contactLowcoder_fetchingDeploymentInfo": "Recupero delle informazioni sulla distribuzione...",
  "contactLowcoder_unableToLoadContactForm": "Impossibile caricare il modulo di contatto",
  "contactLowcoder_apiConfigurationError": "URL del servizio API ambiente o chiave API non configurata",
  "contactLowcoder_failedToFetchDeploymentId": "Impossibile recuperare l'ID dell'installazione client",
  "contactLowcoder_ensureProperConfiguration": "Assicurarsi che l'ambiente sia configurato correttamente per contattare l'assistenza.",
  "credentialConfirmations_firstConfirmation_title": "Avviso di sovrascrittura delle credenziali",
  "credentialConfirmations_firstConfirmation_message": "Questa azione sovrascrive le credenziali esistenti nell'ambiente di destinazione.",
  "credentialConfirmations_firstConfirmation_description": "Si tratta di un'operazione grave che può avere ripercussioni su altre applicazioni e utenti.",
  "credentialConfirmations_firstConfirmation_question": "È sicuro di voler procedere?",
  "credentialConfirmations_firstConfirmation_continueButton": "Continua",
  "credentialConfirmations_firstConfirmation_cancelButton": "Annullamento",
  "credentialConfirmations_secondConfirmation_title": "Richiesta di conferma finale",
  "credentialConfirmations_secondConfirmation_message": "Avviso finale: Sovrascrittura delle credenziali",
  "credentialConfirmations_secondConfirmation_description": "Si stanno per sovrascrivere le credenziali nell'ambiente di destinazione. Questa azione non può essere annullata e può interrompere le integrazioni esistenti.",
  "credentialConfirmations_secondConfirmation_confirmOnceMore": "Si prega di confermare ancora una volta.",
  "credentialConfirmations_secondConfirmation_finalQuestion": "Si è assolutamente certi di voler sovrascrivere le credenziali?",
  "credentialConfirmations_secondConfirmation_confirmButton": "Sì, sovrascrivere le credenziali",
  "credentialConfirmations_secondConfirmation_cancelButton": "Annullamento",
  "config_singularLabels_app": "App",
  "config_singularLabels_dataSource": "Fonte dei dati",
  "config_singularLabels_query": "Interrogazione",
  "config_singularLabels_workspace": "Spazio di lavoro",
  "config_fields_updateDependenciesIfNeeded": "Aggiornare le dipendenze se necessario",
  "config_fields_publishOnTarget": "Pubblicare sull'obiettivo",
  "config_fields_publicToAll": "Pubblico A Tutti",
  "config_fields_publicToMarketplace": "Dal pubblico al mercato",
  "config_fields_overwriteCredentials": "Sovrascrivere le credenziali",
  "services_environments_missingEnvironmentId": "ID ambiente mancante",
  "services_environments_failedToUpdateEnvironment": "Impossibile aggiornare l'ambiente",
  "services_environments_environmentCreatedSuccessfully": "Ambiente creato con successo",
  "services_environments_failedToCreateEnvironment": "Impossibile creare l'ambiente",
  "services_environments_failedToFetchEnvironments": "Impossibile recuperare gli ambienti",
  "services_environments_failedToFetchEnvironment": "Impossibile recuperare l'ambiente",
  "services_environments_environmentIdRequired": "È richiesto l'ID dell'ambiente",
  "services_environments_apiKeyRequiredForWorkspaces": "La chiave API è necessaria per recuperare gli spazi di lavoro.",
  "services_environments_apiServiceUrlRequiredForWorkspaces": "L'URL del servizio API è necessario per recuperare gli spazi di lavoro.",
  "services_environments_failedToFetchWorkspaces": "Impossibile recuperare gli spazi di lavoro",
  "services_environments_apiKeyRequiredForUserGroups": "La chiave API è necessaria per recuperare i gruppi di utenti",
  "services_environments_apiServiceUrlRequiredForUserGroups": "L'URL del servizio API è necessario per recuperare i gruppi di utenti.",
  "services_environments_failedToFetchUserGroups": "Impossibile recuperare i gruppi di utenti",
  "services_environments_workspaceIdRequired": "L'ID dell'area di lavoro è necessario",
  "services_environments_apiKeyRequiredForApps": "La chiave API è necessaria per recuperare le applicazioni",
  "services_environments_apiServiceUrlRequiredForApps": "L'URL del servizio API è necessario per recuperare le applicazioni",
  "services_environments_failedToFetchWorkspaceApps": "Impossibile recuperare le applicazioni dello spazio di lavoro",
  "services_environments_apiKeyRequiredForDataSources": "La chiave API è necessaria per recuperare le fonti di dati",
  "services_environments_apiServiceUrlRequiredForDataSources": "L'URL del servizio API è necessario per recuperare le fonti di dati.",
  "services_environments_failedToFetchWorkspaceDataSources": "Impossibile recuperare le fonti di dati dell'area di lavoro",
  "services_environments_apiKeyRequiredForQueries": "La chiave API è necessaria per recuperare le query",
  "services_environments_apiServiceUrlRequiredForQueries": "L'URL del servizio API è necessario per recuperare le query.",
  "services_environments_failedToFetchWorkspaceQueries": "Impossibile recuperare le query dello spazio di lavoro",
  "services_environments_apiServiceUrlNotConfigured": "URL del servizio API non configurato",
  "services_environments_licenseCheckFailed": "Controllo della licenza fallito",
  "services_environments_apiKeyRequiredForDeploymentId": "La chiave API è necessaria per ottenere l'ID dell'installazione.",
  "services_environments_failedToFetchDeploymentId": "Impossibile recuperare l'ID dell'installazione client",
  "services_enterprise_missingEnvironmentId": "ID ambiente mancante",
  "services_enterprise_failedToFetchManagedWorkspaces": "Impossibile recuperare gli spazi di lavoro gestiti",
  "services_enterprise_missingRequiredParamsToConnectOrg": "Mancano i parametri richiesti per collegare l'area di lavoro",
  "services_enterprise_failedToConnectOrg": "Impossibile connettere l'area di lavoro",
  "services_enterprise_missingOrgGidToUnconnectWorkspace": "GID dello spazio di lavoro mancante per scollegare lo spazio di lavoro",
  "services_enterprise_failedToUnconnectOrg": "Impossibile scollegare l'area di lavoro",
  "services_enterprise_failedToConnectApp": "Impossibile collegare l'applicazione",
  "services_enterprise_failedToUnconnectApp": "Impossibile scollegare l'applicazione",
  "services_enterprise_failedToFetchDataSources": "Impossibile recuperare le fonti di dati",
  "services_enterprise_failedToDeployDataSource": "Impossibile distribuire l'origine dati",
  "services_enterprise_failedToDisconnectManagedDataSource": "Impossibile disconnettere l'origine dati gestita",
  "services_enterprise_environmentIdRequired": "È richiesto l'ID dell'ambiente",
  "services_enterprise_failedToFetchQueries": "Impossibile recuperare le query",
  "services_enterprise_environmentIdAndQueryGidRequired": "Sono richiesti l'ID ambiente e il GID della query",
  "services_enterprise_failedToDeployQuery": "Impossibile distribuire la query",
  "services_enterprise_queryGidRequired": "Il GID della query è necessario",
  "services_enterprise_failedToDisconnectQuery": "Disconnessione della query fallita",
  "services_apps_failedToFetchApps": "Impossibile recuperare le applicazioni",
  "services_apps_failedToDeployApp": "Impossibile distribuire l'applicazione",
  "services_datasources_workspaceIdRequired": "L'ID dell'area di lavoro è necessario",
  "services_datasources_apiKeyRequiredToFetchDataSources": "La chiave API è necessaria per recuperare le fonti di dati",
  "services_datasources_apiServiceUrlRequiredToFetchDataSources": "L'URL del servizio API è necessario per recuperare le fonti di dati.",
  "services_datasources_failedToFetchDataSources": "Impossibile recuperare le fonti di dati",
  "services_datasources_failedToDeployDataSource": "Impossibile distribuire l'origine dati",
  "services_workspace_failedToFetchWorkspaces": "Impossibile recuperare gli spazi di lavoro",
  "services_workspace_failedToDeployWorkspace": "Impossibile distribuire lo spazio di lavoro",
  "services_managedObjects_missingRequiredParameters": "Mancano i parametri richiesti",
  "services_managedObjects_failedToCheckManagedStatus": "Impossibile verificare lo stato di gestione",
  "services_managedObjects_failedToSetAsManaged": "Non è stato possibile impostare {{objType}} come gestito.",
  "services_managedObjects_failedToRemoveFromManaged": "Impossibile rimuovere {{objType}} da managed",
  "services_managedObjects_missingEnvironmentId": "ID ambiente mancante",
  "services_managedObjects_failedToFetchManagedObjects": "Impossibile recuperare gli oggetti gestiti",
  "services_managedObjects_failedToFetchManagedObject": "Impossibile recuperare l'oggetto gestito",
  "services_managedObjects_managedObjectNotFound": "Oggetto gestito non trovato per objGid: {{objGid}}",
  "services_license_apiServiceUrlRequired": "L'URL del servizio API è necessario",
  "services_license_licenseInformationUnavailable": "Informazioni sulla licenza non disponibili",
  "services_license_licenseCheckTookTooLong": "Il controllo della patente ha richiesto troppo tempo",
  "services_license_licenseServiceNotAvailable": "Servizio di licenza non disponibile",
  "services_license_authenticationRequired": "È richiesta l'autenticazione - verificare la chiave API",
  "services_license_licenseServiceTemporarilyUnavailable": "Servizio di licenza temporaneamente non disponibile",
  "services_license_remainingAPICalls": "{{remaining}} rimanenti ({{used}}/{{total}} utilizzati, {{percentage}}%)",
  },
  "subscription": {
    ...en.subscription,

  "details": "Dettagli sull'abbonamento",
  "productDetails": "Dettagli del prodotto",
  "productName": "Nome del prodotto",
  "productDescription": "Descrizione del prodotto",
  "productPrice": "Prezzo del prodotto",
  "subscriptionDetails": "Dettagli sull'abbonamento",
  "status": "Stato",
  "startDate": "Data di inizio",
  "currentPeriodEnd": "Fine periodo corrente",
  "customerId": "ID cliente",
  "subscriptionItems": "Articoli in abbonamento",
  "itemId": "ID articolo",
  "plan": "Piano",
  "quantity": "Quantità",
  "product": "Prodotto",
  ...
  "billingReason": "Motivo della fatturazione",
  "subscriptionCycle": "Abbonamento mensile",
  "customer": "Cliente",
  "links": "Collegamenti",
  "paid": "Pagato",
  "unpaid": "Non pagato",
  "noInvoices": "Non sono disponibili fatture",
  "costVolumeDevelopment": "Sviluppo costi/volumi",
  "noUsageRecords": "Non sono disponibili registri di utilizzo",
  "itemDescription": "Descrizione dell'articolo",
  "periodStart": "Inizio periodo",
  "periodEnd": "Fine periodo",
  "billingReason.subscription_cycle": "Ciclo di abbonamento",
  "billingReason.subscription_create": "Creazione di abbonamenti",
  "billingReason.manual": "Fatturazione manuale",
  "billingReason.upcoming": "Prossima fatturazione",
  "billingReason.subscription_threshold": "Soglia di sottoscrizione",
  "billingReason.subscription_update": "Aggiornamento dell'abbonamento",
  "backToSubscriptions": "Torna a Abbonamenti",
  "manageSubscription": "Gestire gli abbonamenti",
  "subscriptionHelp": "Aiuto per l'abbonamento",
  "subscriptionHelpDescription": "Se avete domande, contattateci. Saremo lieti di aiutarvi. service@lowcoder.cloud",
  "success": "Successo del pagamento e dell'abbonamento",
  "successTitle": "Grazie per essere entrato a far parte della famiglia Lowcoder!",
  "successThankYou": "Siamo entusiasti di averti a bordo! La sua fiducia in Lowcoder significa tutto per noi e ci impegniamo a offrire un'esperienza eccezionale fin dal primo giorno.\n\nIn Lowcoder non sei solo un cliente, ma fai parte di una comunità che promuove l'innovazione e la crescita. La nostra missione è aiutarvi a raggiungere i vostri obiettivi con facilità, sia che ciò significhi risolvere rapidamente le sfide, costruire soluzioni innovative o essere presenti ogni volta che avete bisogno di supporto.\n\nEcco cosa vi aspetta:\n\n- Assistenza di prim'ordine: Il nostro team è pronto ad assistervi in ogni fase.\n- Innovazione continua: Miglioriamo continuamente per offrirvi gli strumenti e le funzionalità migliori.\n- Una partnership per il successo: Il vostro successo è la nostra priorità.\n\nGrazie per averci ispirato a superare i limiti e a cercare l'eccellenza ogni giorno. Non vediamo l'ora di vedere cosa costruiremo insieme.\n\nBenvenuti a bordo! Facciamo accadere cose straordinarie.",
  "successLowcoderTeam": "Il team Lowcoder",
  },
  "subscriptionError": {
    ...en.subscriptionError,

  "fetchProductDetails": "Errore nell'acquisizione dei dettagli del prodotto.",
  "fetchSubscriptionDetails": "Errore nel recupero dei dettagli dell'abbonamento.",
  "fetchInvoices": "Errore nell'acquisizione delle fatture.",
  },
  "auditLog": {
    ...en.auditLog,

  "title": "Dettaglio registro di audit",
  ...
  "inviteByEmailHelp": "È possibile inserire uno o più indirizzi e-mail per inviare i link di invito.",
  "inviteByEmailLabel": "Inserire i messaggi di posta elettronica:",
  "inviteByEmailButton": "Inviare gli inviti",
  "inviteByEmailSuccess": "Inviti inviati con successo!",
  "inviteByEmailError": "Qualcosa è andato storto durante l'invio degli inviti. Si prega di riprovare.",
  "noValidEmails": "Non sono state trovate e-mail valide",
  ...
  "destroyInactiveTab": "Distruggi TabPane inattivo",
  },
  "formComp": {
    ...en.formComp,
  ...
  "invalidFormMessage": "Messaggio personalizzato di modulo non valido",
  ...
  "enableSorting": "Consentire l'ordinamento",
  },
  "navigation": {
    ...en.navigation,
  ...
  "logoutUser": "Disconnessione dell'utente",
  ...
  "chartBuy": "Acquista",
  "canvas": "Impostazioni della tela",
  },
  "themeDetail": {
    ...en.themeDetail,
  ...
  "background": "Stili di sfondo",
  "gridSettings": "Impostazioni della griglia",
  "gridRowHeight": "Altezza della riga della griglia",
  "gridRowHeightDesc": "Altezza di ogni riga della griglia",
  "gridRowCount": "Conteggio delle righe della griglia",
  "gridRowCountDesc": "Numero massimo di righe nella griglia",
  "gridPaddingX": "Imbottitura orizzontale",
  "gridPaddingXDesc": "Imbottitura orizzontale della tela",
  "gridPaddingY": "Imbottitura verticale",
  "gridPaddingYDesc": "Imbottitura verticale della tela",
  "gridBgImage": "Immagine di sfondo",
  "gridBgImageDesc": "Immagine di sfondo della tela",
  "gridBgImageRepeat": "Ripetizione dell'immagine di sfondo",
  "gridBgImageRepeatDesc": "Ripetizione dell'immagine di sfondo della tela",
  "gridBgImageSize": "Dimensioni dell'immagine di sfondo",
  "gridBgImageSizeDesc": "Dimensioni dell'immagine di sfondo della tela",
  "gridBgImagePosition": "Posizione dell'immagine di sfondo",
  "gridBgImagePositionDesc": "Posizione dell'immagine di sfondo della tela",
  "gridBgImageOrigin": "Origine dell'immagine di sfondo",
  "gridBgImageOriginDesc": "Origine dell'immagine di sfondo della tela",
  },
  "pluginSetting": {
    ...en.pluginSetting,
  ...
  "selectWorkspace": "Selezionare l'area di lavoro",
  "brandingName": "Nome del marchio",
  "brandingNamePlaceholder": "Inserire il nome del marchio",
  "brandingDescription": "Descrizione del marchio",
  "brandingDescriptionPlaceholder": "Inserire la descrizione del marchio",
  "logoSection": "Loghi",
  "logo": "Logo",
  "logoHelp": "Carica il logo della tua azienda in formato SVG o PNG.",
  "logoUrlHelp": "Fornire un'immagine valida per il logo.",
  "logoUrlPlaceholder": "URL dell'immagine del fornitore per il logo",
  "squareLogo": "Logo Quadrato",
  "squareLogoHelp": "Carica una versione quadrata del tuo logo in formato SVG o PNG.",
  "squareLogoUrlHelp": "Fornire un url di immagine valido per il logo quadrato.",
  "squareLogoUrlPlaceholder": "Fornire l'url per il logo quadrato.",
  ...
  "adminSidebarFontColor": "Colore del carattere della barra laterale dell'amministrazione",
  "adminSidebarFontColorHelp": "Scegliere il colore dei caratteri per la barra laterale dell'amministratore.",
  "adminSidebarActiveBgColor": "Colore di sfondo dell'elemento selezionato nella barra laterale dell'amministrazione",
  "adminSidebarActiveBgColorHelp": "Scegliere il colore di sfondo dell'elemento selezionato per la barra laterale dell'amministratore.",
  "adminSidebarActiveFontColor": "Colore del carattere dell'elemento selezionato della barra laterale dell'amministrazione",
  "adminSidebarActiveFontColorHelp": "Scegliere il colore del carattere dell'elemento selezionato per la barra laterale dell'amministratore.",
  ...
  "editorSidebarFontColor": "Colore del carattere della barra laterale dell'editor",
  "editorSidebarFontColorHelp": "Scegliere il colore dei caratteri per la barra laterale dell'editor.",
  "editorSidebarActiveBgColor": "Colore di sfondo dell'elemento selezionato nella barra laterale dell'editor",
  "editorSidebarActiveBgColorHelp": "Scegliere il colore di sfondo dell'elemento selezionato per la barra laterale dell'editor.",
  "editorSidebarActiveFontColor": "Colore del carattere dell'elemento selezionato della barra laterale dell'editor",
  "editorSidebarActiveFontColorHelp": "Scegliere il colore del carattere dell'elemento selezionato per la barra laterale dell'editor.",
  "font": "Carattere",
  ...
  "errorPageImageUrl": "URL dell'immagine per la pagina di errore",
  "errorPageImageUrlPlaceholder": "URL dell'immagine del provider per la pagina di errore",
  "errorPageImageUrlHelp": "Fornire un'immagine valida da mostrare nella pagina di errore.",
  "signUpPageImage": "Carica un'immagine per la pagina di registrazione in formato SVG o PNG.",
  "signUpPageImageUrl": "URL dell'immagine per la pagina di iscrizione",
  "signUpPageImageUrlPlaceholder": "URL dell'immagine del fornitore per la pagina di iscrizione",
  "signUpPageImageUrlHelp": "Fornire un'immagine valida da mostrare nella pagina di iscrizione.",
  "loggedOutPageImage": "Carica un'immagine per la pagina di disconnessione in formato SVG o PNG.",
  "showDocumentationSection": "Impostazioni del collegamento alla documentazione",
  "showWhatsNewSection": "Novità Impostazioni dei collegamenti",
  ...
  "deleteBranding": "Cancellare il marchio",
  "deleteBrandingContent": "Siete sicuri di voler eliminare il marchio \"{orgName}\"?",
  "fetchBrandingError": "Qualcosa è andato storto durante il recupero dei dettagli del marchio. Riprovare.",
  "upload": "Caricare",
  },
  "networkMessage": {
    ...en.networkMessage,
  ...
  "gridRowHeight": "Altezza della riga della griglia",
  "gridRowCount": "Conteggio delle righe della griglia",
  "gridPaddingX": "Imbottitura orizzontale della tela",
  "gridPaddingY": "Imbottitura verticale della tela",
  "gridBgImage": "Immagine di sfondo",
  "gridBgImageRepeat": "Ripetizione dell'immagine di sfondo",
  "gridBgImageSize": "Dimensioni dell'immagine di sfondo",
  "gridBgImagePosition": "Posizione dell'immagine di sfondo",
  ...
  "apiKeyInfo": "Assicuratevi di copiare la nuova chiave API. Non sarà più possibile visualizzarla.",
  "apiKeyName": "Nome",
  ...
  "selectAuthProvider": "Selezionare il provider di autenticazione",
  "selectWorkspace": "Selezionare l'area di lavoro",
  "userNotFound": "Utente non trovato. Assicurarsi di aver inserito l'e-mail corretta.",
  },
  "preLoad": {
    ...en.preLoad,
  ...
  "appSharingDialogueTitle": "Condivisione delle app e autorizzazioni",
  "appSocialSharing": "Condividete la vostra applicazione e la vostra esperienza su:",
  "appSocialSharingMessage": "Ho realizzato questa app con Lowcoder, guardatela!",
  "socialShare": "Condividi su",
  ...
  "lastEnabledConfig": "Non è possibile disabilitare/cancellare la configurazione, poiché è l'unica abilitata.",
  "disable": "Disattivare",
  ...
  "searchAnimation": "Ricerca Animazione",
  "speed": "Velocità",
  "width": "Larghezza",
  "height": "Altezza",
  ...
  "column": "Visualizza le aree",
  "addColumn": "Aggiungi aree",
  "columnDefinition": "Definizione dell'area",
  "atLeastOneColumnError": "Il layout responsivo mantiene almeno una colonna",
  "horizontal": "Orizzontale",
  "vertical": "Verticale",
  "areaStyle": "Stile colonna",
  "minWidth": "Min. Larghezza",
  "maxWidth": "Max. Larghezza",
  "width": "Larghezza",
  "collapsible": "L'area è pieghevole?",
  "matchColumnsHeight": "Aree di corrispondenza Altezza",
  "orientation": "Orientamento del layout diviso",
  "orientationTooltip": "L'ordine visivo di allineamento delle aree. Per ottenere layout complessi, è possibile inserire i componenti Splitlayout anche all'interno dei componenti Splitlayout.",
  },
  "navLayout": {
    ...en.navLayout,
  ...
  "UTC+12:00": "(UTC+12:00) Auckland, Figi",
  ...
  "searchImage": "Ricerca immagine",
  "searchAnimation": "Ricerca Animazione",
  "searchIcon": "Icona di ricerca",
  "noResults": "Nessun risultato trovato.",
  "buySubscriptionTitle": "Sbloccare le attività premium",
  "buySubscriptionContent": "Questa risorsa è un'esclusiva degli abbonati a Media Package. Abbonati a Media Package e scarica asset di alta qualità senza limiti!",
  "buySubscriptionButton": "Iscriviti ora",
  },
