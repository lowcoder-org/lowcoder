...
export const it = {
  ...
  "setDesc": "Imposta proprietà: {property}",
  "clearDesc": "Cancella proprietà: {property}",
  "resetDesc": "Ripristina la proprietà: {property} al valore predefinito",
  },
  "method": {
    ...en.method,
  ...
  "deleteCompsSuccess": "Eliminato con successo. Premere il tasto {undoKey} per annullare.",
  "deleteCompsTitle": "Eliminazione dei componenti",
  "deleteCompsBody": "Si è sicuri di voler eliminare i componenti selezionati {compNum}?",
  "cutCompsSuccess": "Tagliare con successo. Premere il tasto {incolla} per incollare o il tasto {annulla} per annullare.",
  },
  "leftPanel": {
    ...en.leftPanel,
  ...
  "expandTip": "Fare clic per mostrare i dati di {componente}.",
  "collapseTip": "Fare clic per nascondere i dati di {componente}.",
  "layers": "Strati",
  ...
  "inlineEventTitle": "Su {nomeevento}",
  "event": "Evento",
  "action": "Azione",
  ...
  "level": "Livello",
  "duration": "Durata",
  "notifyDurationTooltip": "L'unità di tempo può essere 's' (secondo, default) o 'ms' (millisecondo). La durata massima è {max} secondi",
  ...
  "maxLength": "Troppi caratteri, corrente: {lunghezza}, massima: {maxLunghezza}",
  "minLength": "Caratteri insufficienti, corrente: {lunghezza}, minimo: {minLunghezza}",
  "maxValue": "Il valore supera il massimo, corrente: {valore}, massimo: {max}",
  "minValue": "Valore inferiore al minimo, corrente: {valore}, minimo: {min}",
  "maxTime": "Il tempo supera il massimo, corrente: {time}, massimo: {maxTime}",
  "minTime": "Tempo inferiore al minimo, corrente: {ora}, minimo: {minTime}",
  "maxDate": "La data supera il massimo, corrente: {date}, massimo: {maxDate}",
  "minDate": "Data inferiore al minimo, corrente: {date}, minimo: {minDate}",
  },
  "query": {
    ...en.query,

  "noQueries": "Non sono disponibili query di dati.",
  "queryTutorialButton": "Visualizza i documenti {valore}",
  ...
  "successMessageWithName": "{nome} esecuzione riuscita",
  "failMessageWithName": "Esecuzione di {name} fallita: {risultato}",
  ...
  "timeoutTooltip": "Unità predefinita: ms. Unità di input supportate: ms, s. Valore predefinito: {defaultSeconds} secondi. Valore massimo: {maxSecondi} secondi. Ad esempio, 300 (cioè 300ms), 800ms, 5s.",
  ...
  "deleteSuccessMessage": "Eliminato con successo. È possibile utilizzare il tasto {undoKey} per annullare l'operazione.",
  ...
  "address": "Indirizzo:",
  "nameExists": "Il nome {nome} esiste già",
  ...
  "readOnly": "Solo lettura",
  "exit": "Uscita",
  "recoverAppSnapshotContent": "Ripristina la query corrente alla versione {versione}.",
  ...
  "bodyFormDataTooltip": "Se si seleziona {tipo}, il formato del valore deve essere {oggetto}. Esempio: {esempio}",
  "text": "Testo",
  "file": "File",
  ...
  "required": "Richiesto",
  "maximum": "Il valore massimo è {valore}",
  "minimum": "Il valore minimo è {valore}",
  "exclusiveMaximum": "Dovrebbe essere inferiore a {valore}",
  "exclusiveMinimum": "Dovrebbe essere maggiore di {valore}",
  "multipleOf": "Dovrebbe essere un multiplo di {valore}",
  "minLength": "Almeno {valore} Caratteri",
  "maxLength": "Al massimo {valore} Caratteri",
  "pattern": "Dovrebbe corrispondere al modello {valore}",
  "format": "Deve corrispondere al formato {valore}",
  },
  "select": {
    ...en.select,
  ...
  "pageOffsetDesc": "L'inizio corrente del Paging, utilizzato per il Paging per ottenere i dati. Esempio: Selezionare * da Utenti Limitare '{{table1.pageSize}}' Offset '{{table1.pageOffset}}'",
  ...
  "rowColorDesc": "Imposta in modo condizionale il colore della riga in base alle variabili opzionali: CurrentRow, CurrentOriginalIndex, CurrentIndex, ColumnTitle. Ad esempio: '{{ currentRow.id > 3 ? \"verde\" : \"rosso\" }}'",
  "rowHeight": "Altezza di riga condizionale",
  "rowHeightDesc": "Imposta in modo condizionale l'altezza della riga in base alle variabili opzionali: CurrentRow, CurrentOriginalIndex, CurrentIndex, ColumnTitle. Per esempio: '{{ currentRow.id > 3 ? \"60px\" : \"40px\" }}'",
  "cellColor": "Colore della cella condizionale",
  "cellColorDesc": "Impostare in modo condizionale il colore della cella in base al valore della cella utilizzando CurrentCell. Ad esempio: '{{ currentCell == 3 ? \"verde\" : \"rosso\" }}'",
  ...
  "timeoutTypeError": "Immettere il periodo di timeout corretto in ms, l'input corrente è: {valore}",
  "timeoutLessThanMinError": "L'input deve essere maggiore di {left}, l'input corrente è: {valore}",
  },
  "selectionControl": {
    ...en.selectionControl,
  ...
  "moveOutOrgDescSaasMode": "Siete sicuri di voler rimuovere l'utente {nome} da questo spazio di lavoro?",
  "moveOutOrgDesc": "Siete sicuri di voler rimuovere l'utente {nome}? Questa azione non può essere recuperata.",
  ...
  "inviteText": "{nomeutente} ti invita a unirti all'area di lavoro \"{organizzazione}\", clicca sul link per unirti: {invitoLink}",
  ...
  "deleteModalContent": "Si sta per eliminare questo spazio di lavoro {permanentemente eliminato}. Una volta eliminato, lo spazio di lavoro non viene ripristinato.",
  "permanentlyDelete": "In modo permanente",
  "notRestored": "Non può essere ripristinato",
  "deleteModalLabel": "Inserire il nome dell'area di lavoro {nome} per confermare l'operazione:",
  ...
  "noOfRowsTooltip": "Numero di righe nell'elenco - di solito impostato su una variabile (ad esempio, '{{query1.data.length}}') per presentare i risultati della query.",
  ...
  "itemDataNameDesc": "Il nome della variabile che fa riferimento all'oggetto dati dell'elemento, predefinito come {default}.",
  ...
  "deleteMessage": "Eliminazione del trasformatore riuscita. È possibile utilizzare il tasto {undo} per annullare.",
  ...
  "deleteMessage": "Lo stato temporaneo è stato eliminato con successo. È possibile utilizzare il tasto {undoKey} per annullare.",
  ...
  "deleteMessage": "Il risponditore di dati è stato eliminato con successo. È possibile utilizzare il tasto {undoKey} per annullare.",
  ...
  "excuteMethod": "Eseguire il metodo {nome}",
  "method": "Metodo",
  "action": "Azione",
  "output": "Uscita",
  "nameExists": "Nome {nome} già esistente",
  "eventTriggered": "L'evento {nome} è stato attivato",
  ...
  "createCompFail": "Crea componente {comp} Fallito",
  "notHandledError": "{metodo} Metodo non eseguito",
  },
  "aggregation": {
    ...en.aggregation,
  ...
  "bindingSuccess": "Legame {nome sorgente} Successo",
  ...
  "bindName": "Legare {nome}",
  "loginAfterBind": "Dopo il binding, è possibile utilizzare {nome} per accedere",
  ...
  "recoverAppSnapshotContent": "Ripristina l'applicazione corrente alla versione creata al {tempo}.",
  "recoverAppSnapshotMessage": "Ripristinare questa versione",
  "returnEdit": "Ritorno all'editore",
  "deploy": "Pubblicare",
  "export": "Esportazione in JSON",
  "editName": "Modifica nome",
  "duplicate": "Duplicato di {tipo}",
  "snapshot": "La storia",
  ...
  "welcomeTitle": "Benvenuti a {nome prodotto}",
  ...
  "signInLabel": "Accedi con {nome}",
  "bindAccount": "Legare il conto",
  "scanQrCode": "Scansionate il codice QR con {nome}",
  ...
  "resetPasswordDesc": "Reimpostare la password dell'utente {nome}. Dopo la reimpostazione verrà generata una nuova password.",
  ...
  "jsLibraryInstallFailedHost": "{messaggio}",
  "add": "Aggiungi nuovo",
  ...
  "moveToFolderSubTitle": "Spostare \"{nome}\" in:",
  "folderName": "Nome della cartella:",
  "resCardSubTitle": "{ora} da parte del {creatore}",
  ...
  "moveToTrashSubTitle": "{tipo} {nome} sarà spostato nel cestino.",
  "deleteElementSubTitle": "Cancellare {tipo} {nome} in modo permanente, non può essere recuperato.",
  ...
  "newNavLayout": "{nomeutente} di {nome}",
  "newApp": "Il nuovo {nomeutente} di {nome}",
  "importError": "Errore di importazione, {messaggio}",
  "exportError": "Errore di esportazione, {messaggio}",
  ...
  "orgName": "{orgName} amministratori",
  "addMember": "Aggiungi membri",
  "addPermissionPlaceholder": "Inserire un nome per cercare i membri",
  "searchMemberOrGroup": "Ricerca di membri o gruppi:",
  "addPermissionErrorMessage": "Impossibile aggiungere l'autorizzazione, {messaggio}",
  "copyModalTitle": "Clona \"{nome}\"",
  "copyNameLabel": "{tipo} nome",
  "copyModalfolderLabel": "Aggiungi alla cartella",
  "copyNamePlaceholder": "Inserire un nome di {tipo}",
  ...
  "compNotFound": "Componente {nomeComp} non trovato.",
  ...
  "example": "Esempi",
  "defaultMethodDesc": "Impostare il valore della proprietà {nome}",
  ...
  "save": "Risparmiare",
  "none": "Nessuno",
  "formPlaceholder": "Inserire {etichetta}",
  "formSelectPlaceholder": "Selezionare la {etichetta}",
  "saveSuccess": "Salvato con successo",
  ...
  "manualTip": "",
  "lockTip": "Il contenuto è bloccato. Per apportare modifiche, fare clic sul pulsante {icon} per sbloccare.",
  ...
  "tooltipFunctionSignature": "booleano | { pointAtCenter: booleano }",
  },
  "type": {
