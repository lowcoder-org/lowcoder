    	...
    	http
            ...
            .authorizeExchange(customizer -> customizer
                ...
                .matchers(
                        ...
                        ServerWebExchangeMatchers.pathMatchers(HttpMethod.GET, APPLICATION_URL + "/*/manifest.json"), // app manifest
                        ...
                        ServerWebExchangeMatchers.pathMatchers(HttpMethod.GET, NewUrl.APPLICATION_URL + "/*/manifest.json"), // app manifest
